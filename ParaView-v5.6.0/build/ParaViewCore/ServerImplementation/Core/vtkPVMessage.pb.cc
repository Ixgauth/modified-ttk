...
void protobuf_AssignDesc_vtkPVMessage_2eproto() {
  ...
  static const int ClientsInformation_ClientInfo_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ClientsInformation_ClientInfo, disable_further_connections_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ClientsInformation_ClientInfo, connect_id_),
  };
...
void protobuf_AddDesc_vtkPVMessage_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "tobuf.Message\030K \001(\r2)\n\005range\022\032.paraview_"
    "protobuf.Message\030L \003(\001\"\223\002\n\022ClientsInform"
    "ation\032\240\001\n\nClientInfo\022\014\n\004user\030\001 \002(\r\022\014\n\004na"
    "me\030\002 \001(\t\022\030\n\tis_master\030\003 \001(\010:\005false\022\031\n\nfo"
    "llow_cam\030\004 \001(\010:\005false\022*\n\033disable_further"
    "_connections\030\005 \001(\010:\005false\022\025\n\nconnect_id\030"
    "\006 \001(\r:\00102Z\n\004user\022\032.paraview_protobuf.Mes"
    "sage\030P \003(\01320.paraview_protobuf.ClientsIn"
    "formation.ClientInfo\"b\n\013ChatMessage2*\n\006a"
    "uthor\022\032.paraview_protobuf.Message\030T \001(\r2"
    "\'\n\003txt\022\032.paraview_protobuf.Message\030U \001(\t"
    "\"\177\n\007QtEvent\"\"\n\013QtEventType\022\010\n\004CHAT\020\001\022\t\n\005"
    "OTHER\020\0032P\n\004type\022\032.paraview_protobuf.Mess"
    "age\030b \001(\0162&.paraview_protobuf.QtEvent.Qt"
    "EventType", 4049);
...
const int ClientsInformation_ClientInfo::kDisableFurtherConnectionsFieldNumber;
const int ClientsInformation_ClientInfo::kConnectIdFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_disable_further_connections;
        break;
      }
      ...
      case 5: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_disable_further_connections:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   bool, ::google::protobuf::internal::WireFormatLite::TYPE_BOOL>(
                 input, &disable_further_connections_)));
          _set_bit(4);
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(48)) goto parse_connect_id;
        break;
      }
...
void ClientsInformation_ClientInfo::SerializeWithCachedSizes(
  ...
  // optional bool disable_further_connections = 5 [default = false];
  if (_has_bit(4)) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(5, this->disable_further_connections(), output);
  }
  
  // optional uint32 connect_id = 6 [default = 0];
  if (_has_bit(5)) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(6, this->connect_id(), output);
  }
...
::google::protobuf::uint8* ClientsInformation_ClientInfo::SerializeWithCachedSizesToArray(
  ...
  // optional bool disable_further_connections = 5 [default = false];
  if (_has_bit(4)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(5, this->disable_further_connections(), target);
  }
  
  // optional uint32 connect_id = 6 [default = 0];
  if (_has_bit(5)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(6, this->connect_id(), target);
  }
...
int ClientsInformation_ClientInfo::ByteSize() const {
  ...
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    // optional bool disable_further_connections = 5 [default = false];
    if (has_disable_further_connections()) {
      total_size += 1 + 1;
    }
...
void ClientsInformation_ClientInfo::MergeFrom(const ClientsInformation_ClientInfo& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from._has_bit(4)) {
      set_disable_further_connections(from.disable_further_connections());
    }
    if (from._has_bit(5)) {
      set_connect_id(from.connect_id());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void ClientsInformation_ClientInfo::Swap(ClientsInformation_ClientInfo* other) {
  if (other != this) {
    ...
    std::swap(disable_further_connections_, other->disable_further_connections_);
    std::swap(connect_id_, other->connect_id_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
