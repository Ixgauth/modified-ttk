...
class VTKPVSERVERIMPLEMENTATIONCORE_EXPORT ClientsInformation_ClientInfo : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_disable_further_connections() const;
  inline void clear_disable_further_connections();
  static const int kDisableFurtherConnectionsFieldNumber = 5;
  inline bool disable_further_connections() const;
  inline void set_disable_further_connections(bool value);
  
  // optional uint32 connect_id = 6 [default = 0];
  inline bool has_connect_id() const;
  inline void clear_connect_id();
  static const int kConnectIdFieldNumber = 6;
  inline ::google::protobuf::uint32 connect_id() const;
  inline void set_connect_id(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::uint32 connect_id_;
  friend void VTKPVSERVERIMPLEMENTATIONCORE_EXPORT protobuf_AddDesc_vtkPVMessage_2eproto();
  friend void protobuf_AssignDesc_vtkPVMessage_2eproto();
  friend void protobuf_ShutdownFile_vtkPVMessage_2eproto();
...
inline ::google::protobuf::uint32 ClientsInformation_ClientInfo::connect_id() const {
  return connect_id_;
}
inline void ClientsInformation_ClientInfo::set_connect_id(::google::protobuf::uint32 value) {
  _set_bit(5);
  connect_id_ = value;
}
