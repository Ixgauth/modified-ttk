...
// From file /home/ian/ttk/ParaView-v5.6.0/Plugins/StreamingParticles/StreamingParticles.xml
...
char* StreamingParticlesStreamingParticlesInterfaces()
{
  ...
  const size_t len0 = strlen(StreamingParticlesStreamingParticlesInterfaces0);
  size_t len = ( 0
    + len0 );
  char* res = new char[ len + 1];
  size_t offset = 0;
  std::copy(StreamingParticlesStreamingParticlesInterfaces0, StreamingParticlesStreamingParticlesInterfaces0 + len0, res + offset); offset += len0;
  assert(offset == len);
  res[offset] = 0;
  return res;
}
