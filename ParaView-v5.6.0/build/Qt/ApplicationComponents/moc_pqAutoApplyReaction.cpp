...
#include "../../../Qt/ApplicationComponents/pqAutoApplyReaction.h"
...
struct qt_meta_stringdata_pqAutoApplyReaction_t {
    QByteArrayData data[4];
    char stringdata0[51];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqAutoApplyReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqAutoApplyReaction_t qt_meta_stringdata_pqAutoApplyReaction = {
    {
QT_MOC_LITERAL(0, 0, 19), // "pqAutoApplyReaction"
QT_MOC_LITERAL(1, 20, 11), // "updateState"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 17) // "checkStateChanged"

    },
    "pqAutoApplyReaction\0updateState\0\0"
    "checkStateChanged"
};
...
const QMetaObject pqAutoApplyReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqAutoApplyReaction.data,
      qt_meta_data_pqAutoApplyReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqAutoApplyReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqAutoApplyReaction.stringdata0))
