...
#include "../../../Qt/ApplicationComponents/pqAutoLoadPluginXMLBehavior.h"
...
struct qt_meta_stringdata_pqAutoLoadPluginXMLBehavior_t {
    QByteArrayData data[3];
    char stringdata0[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqAutoLoadPluginXMLBehavior_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqAutoLoadPluginXMLBehavior_t qt_meta_stringdata_pqAutoLoadPluginXMLBehavior = {
    {
QT_MOC_LITERAL(0, 0, 27), // "pqAutoLoadPluginXMLBehavior"
QT_MOC_LITERAL(1, 28, 15), // "updateResources"
QT_MOC_LITERAL(2, 44, 0) // ""

    },
    "pqAutoLoadPluginXMLBehavior\0updateResources\0"
    ""
};
...
const QMetaObject pqAutoLoadPluginXMLBehavior::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqAutoLoadPluginXMLBehavior.data,
      qt_meta_data_pqAutoLoadPluginXMLBehavior,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqAutoLoadPluginXMLBehavior::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqAutoLoadPluginXMLBehavior.stringdata0))
