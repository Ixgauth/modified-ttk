...
#include "../../../Qt/ApplicationComponents/pqCTHArraySelectionDecorator.h"
...
struct qt_meta_stringdata_pqCTHArraySelectionDecorator_t {
    QByteArrayData data[3];
    char stringdata0[46];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqCTHArraySelectionDecorator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqCTHArraySelectionDecorator_t qt_meta_stringdata_pqCTHArraySelectionDecorator = {
    {
QT_MOC_LITERAL(0, 0, 28), // "pqCTHArraySelectionDecorator"
QT_MOC_LITERAL(1, 29, 15), // "updateSelection"
QT_MOC_LITERAL(2, 45, 0) // ""

    },
    "pqCTHArraySelectionDecorator\0"
    "updateSelection\0"
};
...
const QMetaObject pqCTHArraySelectionDecorator::staticMetaObject = {
    { &pqPropertyWidgetDecorator::staticMetaObject, qt_meta_stringdata_pqCTHArraySelectionDecorator.data,
      qt_meta_data_pqCTHArraySelectionDecorator,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqCTHArraySelectionDecorator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqCTHArraySelectionDecorator.stringdata0))
