...
#include "../../../Qt/ApplicationComponents/pqCameraUndoRedoReaction.h"
...
struct qt_meta_stringdata_pqCameraUndoRedoReaction_t {
    QByteArrayData data[6];
    char stringdata0[66];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqCameraUndoRedoReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqCameraUndoRedoReaction_t qt_meta_stringdata_pqCameraUndoRedoReaction = {
    {
QT_MOC_LITERAL(0, 0, 24), // "pqCameraUndoRedoReaction"
QT_MOC_LITERAL(1, 25, 10), // "setEnabled"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 6), // "enable"
QT_MOC_LITERAL(4, 44, 13), // "setActiveView"
QT_MOC_LITERAL(5, 58, 7) // "pqView*"

    },
    "pqCameraUndoRedoReaction\0setEnabled\0"
    "\0enable\0setActiveView\0pqView*"
};
...
const QMetaObject pqCameraUndoRedoReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqCameraUndoRedoReaction.data,
      qt_meta_data_pqCameraUndoRedoReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqCameraUndoRedoReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqCameraUndoRedoReaction.stringdata0))
