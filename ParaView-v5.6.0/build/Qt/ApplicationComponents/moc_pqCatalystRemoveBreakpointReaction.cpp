...
#include "../../../Qt/ApplicationComponents/pqCatalystRemoveBreakpointReaction.h"
...
struct qt_meta_stringdata_pqCatalystRemoveBreakpointReaction_t {
    QByteArrayData data[3];
    char stringdata0[54];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqCatalystRemoveBreakpointReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqCatalystRemoveBreakpointReaction_t qt_meta_stringdata_pqCatalystRemoveBreakpointReaction = {
    {
QT_MOC_LITERAL(0, 0, 34), // "pqCatalystRemoveBreakpointRea..."
QT_MOC_LITERAL(1, 35, 17), // "updateEnableState"
QT_MOC_LITERAL(2, 53, 0) // ""

    },
    "pqCatalystRemoveBreakpointReaction\0"
    "updateEnableState\0"
};
...
const QMetaObject pqCatalystRemoveBreakpointReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqCatalystRemoveBreakpointReaction.data,
      qt_meta_data_pqCatalystRemoveBreakpointReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqCatalystRemoveBreakpointReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqCatalystRemoveBreakpointReaction.stringdata0))
