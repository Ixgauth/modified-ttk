...
#include "../../../Qt/ApplicationComponents/pqChangePipelineInputReaction.h"
...
struct qt_meta_stringdata_pqChangePipelineInputReaction_t {
    QByteArrayData data[3];
    char stringdata0[49];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqChangePipelineInputReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqChangePipelineInputReaction_t qt_meta_stringdata_pqChangePipelineInputReaction = {
    {
QT_MOC_LITERAL(0, 0, 29), // "pqChangePipelineInputReaction"
QT_MOC_LITERAL(1, 30, 17), // "updateEnableState"
QT_MOC_LITERAL(2, 48, 0) // ""

    },
    "pqChangePipelineInputReaction\0"
    "updateEnableState\0"
};
...
const QMetaObject pqChangePipelineInputReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqChangePipelineInputReaction.data,
      qt_meta_data_pqChangePipelineInputReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqChangePipelineInputReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqChangePipelineInputReaction.stringdata0))
