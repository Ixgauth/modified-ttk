...
#include "../../../Qt/ApplicationComponents/pqCommandButtonPropertyWidget.h"
...
struct qt_meta_stringdata_pqCommandButtonPropertyWidget_t {
    QByteArrayData data[3];
    char stringdata0[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqCommandButtonPropertyWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqCommandButtonPropertyWidget_t qt_meta_stringdata_pqCommandButtonPropertyWidget = {
    {
QT_MOC_LITERAL(0, 0, 29), // "pqCommandButtonPropertyWidget"
QT_MOC_LITERAL(1, 30, 13), // "buttonClicked"
QT_MOC_LITERAL(2, 44, 0) // ""

    },
    "pqCommandButtonPropertyWidget\0"
    "buttonClicked\0"
};
...
const QMetaObject pqCommandButtonPropertyWidget::staticMetaObject = {
    { &pqPropertyWidget::staticMetaObject, qt_meta_stringdata_pqCommandButtonPropertyWidget.data,
      qt_meta_data_pqCommandButtonPropertyWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqCommandButtonPropertyWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqCommandButtonPropertyWidget.stringdata0))
