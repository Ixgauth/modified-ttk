...
#include "../../../Qt/ApplicationComponents/pqEditCameraReaction.h"
...
struct qt_meta_stringdata_pqEditCameraReaction_t {
    QByteArrayData data[3];
    char stringdata0[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqEditCameraReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqEditCameraReaction_t qt_meta_stringdata_pqEditCameraReaction = {
    {
QT_MOC_LITERAL(0, 0, 20), // "pqEditCameraReaction"
QT_MOC_LITERAL(1, 21, 17), // "updateEnableState"
QT_MOC_LITERAL(2, 39, 0) // ""

    },
    "pqEditCameraReaction\0updateEnableState\0"
    ""
};
...
const QMetaObject pqEditCameraReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqEditCameraReaction.data,
      qt_meta_data_pqEditCameraReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqEditCameraReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqEditCameraReaction.stringdata0))
