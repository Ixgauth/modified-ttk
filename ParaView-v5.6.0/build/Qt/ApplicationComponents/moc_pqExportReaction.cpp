...
#include "../../../Qt/ApplicationComponents/pqExportReaction.h"
...
struct qt_meta_stringdata_pqExportReaction_t {
    QByteArrayData data[3];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqExportReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqExportReaction_t qt_meta_stringdata_pqExportReaction = {
    {
QT_MOC_LITERAL(0, 0, 16), // "pqExportReaction"
QT_MOC_LITERAL(1, 17, 17), // "updateEnableState"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "pqExportReaction\0updateEnableState\0"
};
...
const QMetaObject pqExportReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqExportReaction.data,
      qt_meta_data_pqExportReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqExportReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqExportReaction.stringdata0))
