...
#include "../../../Qt/ApplicationComponents/pqLoadStateReaction.h"
...
struct qt_meta_stringdata_pqLoadStateReaction_t {
    QByteArrayData data[3];
    char stringdata0[39];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqLoadStateReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqLoadStateReaction_t qt_meta_stringdata_pqLoadStateReaction = {
    {
QT_MOC_LITERAL(0, 0, 19), // "pqLoadStateReaction"
QT_MOC_LITERAL(1, 20, 17), // "updateEnableState"
QT_MOC_LITERAL(2, 38, 0) // ""

    },
    "pqLoadStateReaction\0updateEnableState\0"
    ""
};
...
const QMetaObject pqLoadStateReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqLoadStateReaction.data,
      qt_meta_data_pqLoadStateReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqLoadStateReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqLoadStateReaction.stringdata0))
