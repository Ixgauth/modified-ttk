...
#include "../../../Qt/ApplicationComponents/pqMacroReaction.h"
...
struct qt_meta_stringdata_pqMacroReaction_t {
    QByteArrayData data[3];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqMacroReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqMacroReaction_t qt_meta_stringdata_pqMacroReaction = {
    {
QT_MOC_LITERAL(0, 0, 15), // "pqMacroReaction"
QT_MOC_LITERAL(1, 16, 6), // "enable"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "pqMacroReaction\0enable\0"
};
...
const QMetaObject pqMacroReaction::staticMetaObject = {
    { &pqMasterOnlyReaction::staticMetaObject, qt_meta_stringdata_pqMacroReaction.data,
      qt_meta_data_pqMacroReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqMacroReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqMacroReaction.stringdata0))
