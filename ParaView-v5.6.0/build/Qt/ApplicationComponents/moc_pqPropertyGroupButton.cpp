...
#include "../../../Qt/ApplicationComponents/pqPropertyGroupButton.h"
...
struct qt_meta_stringdata_pqPropertyGroupButton_t {
    QByteArrayData data[3];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqPropertyGroupButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqPropertyGroupButton_t qt_meta_stringdata_pqPropertyGroupButton = {
    {
QT_MOC_LITERAL(0, 0, 21), // "pqPropertyGroupButton"
QT_MOC_LITERAL(1, 22, 10), // "showEditor"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "pqPropertyGroupButton\0showEditor\0"
};
...
const QMetaObject pqPropertyGroupButton::staticMetaObject = {
    { &pqPropertyGroupWidget::staticMetaObject, qt_meta_stringdata_pqPropertyGroupButton.data,
      qt_meta_data_pqPropertyGroupButton,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqPropertyGroupButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqPropertyGroupButton.stringdata0))
