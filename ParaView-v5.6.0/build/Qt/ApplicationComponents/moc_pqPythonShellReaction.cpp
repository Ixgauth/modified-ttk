...
#include "../../../Qt/ApplicationComponents/pqPythonShellReaction.h"
...
struct qt_meta_stringdata_pqPythonShellReaction_t {
    QByteArrayData data[1];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqPythonShellReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqPythonShellReaction_t qt_meta_stringdata_pqPythonShellReaction = {
    {
QT_MOC_LITERAL(0, 0, 21) // "pqPythonShellReaction"
...
const QMetaObject pqPythonShellReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqPythonShellReaction.data,
      qt_meta_data_pqPythonShellReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqPythonShellReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqPythonShellReaction.stringdata0))
