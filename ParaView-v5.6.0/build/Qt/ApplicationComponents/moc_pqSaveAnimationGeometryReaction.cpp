...
#include "../../../Qt/ApplicationComponents/pqSaveAnimationGeometryReaction.h"
...
struct qt_meta_stringdata_pqSaveAnimationGeometryReaction_t {
    QByteArrayData data[3];
    char stringdata0[51];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqSaveAnimationGeometryReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqSaveAnimationGeometryReaction_t qt_meta_stringdata_pqSaveAnimationGeometryReaction = {
    {
QT_MOC_LITERAL(0, 0, 31), // "pqSaveAnimationGeometryReaction"
QT_MOC_LITERAL(1, 32, 17), // "updateEnableState"
QT_MOC_LITERAL(2, 50, 0) // ""

    },
    "pqSaveAnimationGeometryReaction\0"
    "updateEnableState\0"
};
...
const QMetaObject pqSaveAnimationGeometryReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqSaveAnimationGeometryReaction.data,
      qt_meta_data_pqSaveAnimationGeometryReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqSaveAnimationGeometryReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqSaveAnimationGeometryReaction.stringdata0))
