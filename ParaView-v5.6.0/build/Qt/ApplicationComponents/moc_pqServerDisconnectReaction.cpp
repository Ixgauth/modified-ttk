...
#include "../../../Qt/ApplicationComponents/pqServerDisconnectReaction.h"
...
struct qt_meta_stringdata_pqServerDisconnectReaction_t {
    QByteArrayData data[3];
    char stringdata0[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqServerDisconnectReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqServerDisconnectReaction_t qt_meta_stringdata_pqServerDisconnectReaction = {
    {
QT_MOC_LITERAL(0, 0, 26), // "pqServerDisconnectReaction"
QT_MOC_LITERAL(1, 27, 11), // "updateState"
QT_MOC_LITERAL(2, 39, 0) // ""

    },
    "pqServerDisconnectReaction\0updateState\0"
    ""
};
...
const QMetaObject pqServerDisconnectReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqServerDisconnectReaction.data,
      qt_meta_data_pqServerDisconnectReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqServerDisconnectReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqServerDisconnectReaction.stringdata0))
