...
#include "../../../Qt/ApplicationComponents/pqSourcesMenuReaction.h"
...
struct qt_meta_stringdata_pqSourcesMenuReaction_t {
    QByteArrayData data[6];
    char stringdata0[64];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqSourcesMenuReaction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqSourcesMenuReaction_t qt_meta_stringdata_pqSourcesMenuReaction = {
    {
QT_MOC_LITERAL(0, 0, 21), // "pqSourcesMenuReaction"
QT_MOC_LITERAL(1, 22, 17), // "updateEnableState"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 11), // "onTriggered"
QT_MOC_LITERAL(4, 53, 5), // "group"
QT_MOC_LITERAL(5, 59, 4) // "name"

    },
    "pqSourcesMenuReaction\0updateEnableState\0"
    "\0onTriggered\0group\0name"
};
...
const QMetaObject pqSourcesMenuReaction::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqSourcesMenuReaction.data,
      qt_meta_data_pqSourcesMenuReaction,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqSourcesMenuReaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqSourcesMenuReaction.stringdata0))
