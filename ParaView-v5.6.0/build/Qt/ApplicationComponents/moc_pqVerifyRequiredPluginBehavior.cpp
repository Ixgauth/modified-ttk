...
#include "../../../Qt/ApplicationComponents/pqVerifyRequiredPluginBehavior.h"
...
struct qt_meta_stringdata_pqVerifyRequiredPluginBehavior_t {
    QByteArrayData data[3];
    char stringdata0[57];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqVerifyRequiredPluginBehavior_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqVerifyRequiredPluginBehavior_t qt_meta_stringdata_pqVerifyRequiredPluginBehavior = {
    {
QT_MOC_LITERAL(0, 0, 30), // "pqVerifyRequiredPluginBehavior"
QT_MOC_LITERAL(1, 31, 24), // "requiredPluginsNotLoaded"
QT_MOC_LITERAL(2, 56, 0) // ""

    },
    "pqVerifyRequiredPluginBehavior\0"
...
const QMetaObject pqVerifyRequiredPluginBehavior::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqVerifyRequiredPluginBehavior.data,
      qt_meta_data_pqVerifyRequiredPluginBehavior,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqVerifyRequiredPluginBehavior::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqVerifyRequiredPluginBehavior.stringdata0))
