...
#include "../../../Qt/ApplicationComponents/pqViewTypePropertyWidget.h"
...
struct qt_meta_stringdata_pqViewTypePropertyWidget_t {
    QByteArrayData data[5];
    char stringdata0[54];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqViewTypePropertyWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqViewTypePropertyWidget_t qt_meta_stringdata_pqViewTypePropertyWidget = {
    {
QT_MOC_LITERAL(0, 0, 24), // "pqViewTypePropertyWidget"
...
QT_MOC_LITERAL(4, 48, 5) // "value"
    ...
    "pqViewTypePropertyWidget\0valueChanged\0"
    "\0setValue\0value"
};
...
void pqViewTypePropertyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (pqViewTypePropertyWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&pqViewTypePropertyWidget::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject pqViewTypePropertyWidget::staticMetaObject = {
    { &pqPropertyWidget::staticMetaObject, qt_meta_stringdata_pqViewTypePropertyWidget.data,
      qt_meta_data_pqViewTypePropertyWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqViewTypePropertyWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqViewTypePropertyWidget.stringdata0))
