...
#include "../../../Qt/Components/pqChangeInputDialog.h"
...
struct qt_meta_stringdata_pqChangeInputDialog_t {
    QByteArrayData data[4];
    char stringdata0[55];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqChangeInputDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqChangeInputDialog_t qt_meta_stringdata_pqChangeInputDialog = {
    {
QT_MOC_LITERAL(0, 0, 19), // "pqChangeInputDialog"
QT_MOC_LITERAL(1, 20, 16), // "inputPortToggled"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 16) // "selectionChanged"

    },
    "pqChangeInputDialog\0inputPortToggled\0"
    "\0selectionChanged"
};
...
const QMetaObject pqChangeInputDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_pqChangeInputDialog.data,
      qt_meta_data_pqChangeInputDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqChangeInputDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqChangeInputDialog.stringdata0))
