...
#include "../../../Qt/Components/pqComboBoxDomain.h"
...
struct qt_meta_stringdata_pqComboBoxDomain_t {
    QByteArrayData data[4];
    char stringdata0[54];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqComboBoxDomain_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqComboBoxDomain_t qt_meta_stringdata_pqComboBoxDomain = {
    {
QT_MOC_LITERAL(0, 0, 16), // "pqComboBoxDomain"
QT_MOC_LITERAL(1, 17, 13), // "domainChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 21) // "internalDomainChanged"

    },
    "pqComboBoxDomain\0domainChanged\0\0"
...
const QMetaObject pqComboBoxDomain::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqComboBoxDomain.data,
      qt_meta_data_pqComboBoxDomain,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqComboBoxDomain::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqComboBoxDomain.stringdata0))
