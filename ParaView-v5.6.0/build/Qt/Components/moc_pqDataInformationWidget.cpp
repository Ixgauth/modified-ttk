...
#include "../../../Qt/Components/pqDataInformationWidget.h"
...
struct qt_meta_stringdata_pqDataInformationWidget_t {
    QByteArrayData data[4];
    char stringdata0[67];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqDataInformationWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqDataInformationWidget_t qt_meta_stringdata_pqDataInformationWidget = {
    {
QT_MOC_LITERAL(0, 0, 23), // "pqDataInformationWidget"
QT_MOC_LITERAL(1, 24, 21), // "showHeaderContextMenu"
QT_MOC_LITERAL(2, 46, 0), // ""
QT_MOC_LITERAL(3, 47, 19) // "showBodyContextMenu"

    },
    "pqDataInformationWidget\0showHeaderContextMenu\0"
    "\0showBodyContextMenu"
};
...
const QMetaObject pqDataInformationWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_pqDataInformationWidget.data,
      qt_meta_data_pqDataInformationWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqDataInformationWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqDataInformationWidget.stringdata0))
