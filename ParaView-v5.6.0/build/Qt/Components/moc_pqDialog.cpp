...
#include "../../../Qt/Components/pqDialog.h"
...
void pqDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&pqDialog::beginUndo)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&pqDialog::endUndo)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_pqDialog.data,
      qt_meta_data_pqDialog,  qt_static_metacall, nullptr, nullptr}
};
