...
#include "../../../Qt/Components/pqItemViewSearchWidgetEventPlayer.h"
...
struct qt_meta_stringdata_pqItemViewSearchWidgetEventPlayer_t {
    QByteArrayData data[1];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqItemViewSearchWidgetEventPlayer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqItemViewSearchWidgetEventPlayer_t qt_meta_stringdata_pqItemViewSearchWidgetEventPlayer = {
    {
QT_MOC_LITERAL(0, 0, 33) // "pqItemViewSearchWidgetEventPl..."
...
const QMetaObject pqItemViewSearchWidgetEventPlayer::staticMetaObject = {
    { &pqWidgetEventPlayer::staticMetaObject, qt_meta_stringdata_pqItemViewSearchWidgetEventPlayer.data,
      qt_meta_data_pqItemViewSearchWidgetEventPlayer,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqItemViewSearchWidgetEventPlayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqItemViewSearchWidgetEventPlayer.stringdata0))
