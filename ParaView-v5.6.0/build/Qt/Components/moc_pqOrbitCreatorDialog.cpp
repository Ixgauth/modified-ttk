...
#include "../../../Qt/Components/pqOrbitCreatorDialog.h"
...
struct qt_meta_stringdata_pqOrbitCreatorDialog_t {
    QByteArrayData data[3];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqOrbitCreatorDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqOrbitCreatorDialog_t qt_meta_stringdata_pqOrbitCreatorDialog = {
    {
QT_MOC_LITERAL(0, 0, 20), // "pqOrbitCreatorDialog"
QT_MOC_LITERAL(1, 21, 11), // "resetBounds"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "pqOrbitCreatorDialog\0resetBounds\0"
};
...
const QMetaObject pqOrbitCreatorDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_pqOrbitCreatorDialog.data,
      qt_meta_data_pqOrbitCreatorDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqOrbitCreatorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqOrbitCreatorDialog.stringdata0))
