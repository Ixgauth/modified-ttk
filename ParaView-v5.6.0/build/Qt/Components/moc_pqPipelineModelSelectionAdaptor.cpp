...
#include "../../../Qt/Components/pqPipelineModelSelectionAdaptor.h"
...
struct qt_meta_stringdata_pqPipelineModelSelectionAdaptor_t {
    QByteArrayData data[1];
    char stringdata0[32];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqPipelineModelSelectionAdaptor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqPipelineModelSelectionAdaptor_t qt_meta_stringdata_pqPipelineModelSelectionAdaptor = {
    {
QT_MOC_LITERAL(0, 0, 31) // "pqPipelineModelSelectionAdaptor"
...
const QMetaObject pqPipelineModelSelectionAdaptor::staticMetaObject = {
    { &pqSelectionAdaptor::staticMetaObject, qt_meta_stringdata_pqPipelineModelSelectionAdaptor.data,
      qt_meta_data_pqPipelineModelSelectionAdaptor,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqPipelineModelSelectionAdaptor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqPipelineModelSelectionAdaptor.stringdata0))
