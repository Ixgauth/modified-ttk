...
#include "../../../Qt/Components/pqPluginTreeWidgetEventTranslator.h"
...
struct qt_meta_stringdata_pqPluginTreeWidgetEventTranslator_t {
    QByteArrayData data[6];
    char stringdata0[89];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqPluginTreeWidgetEventTranslator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqPluginTreeWidgetEventTranslator_t qt_meta_stringdata_pqPluginTreeWidgetEventTranslator = {
    {
QT_MOC_LITERAL(0, 0, 33), // "pqPluginTreeWidgetEventTransl..."
QT_MOC_LITERAL(1, 34, 13), // "onItemChanged"
QT_MOC_LITERAL(2, 48, 0), // ""
QT_MOC_LITERAL(3, 49, 10), // "onExpanded"
QT_MOC_LITERAL(4, 60, 11), // "onCollapsed"
QT_MOC_LITERAL(5, 72, 16) // "onCurrentChanged"

    },
    "pqPluginTreeWidgetEventTranslator\0"
    "onItemChanged\0\0onExpanded\0onCollapsed\0"
    "onCurrentChanged"
};
...
const QMetaObject pqPluginTreeWidgetEventTranslator::staticMetaObject = {
    { &pqWidgetEventTranslator::staticMetaObject, qt_meta_stringdata_pqPluginTreeWidgetEventTranslator.data,
      qt_meta_data_pqPluginTreeWidgetEventTranslator,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqPluginTreeWidgetEventTranslator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqPluginTreeWidgetEventTranslator.stringdata0))
