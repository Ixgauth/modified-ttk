...
#include "../../../Qt/Components/pqPropertyGroupWidget.h"
...
struct qt_meta_stringdata_pqPropertyGroupWidget_t {
    QByteArrayData data[1];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqPropertyGroupWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqPropertyGroupWidget_t qt_meta_stringdata_pqPropertyGroupWidget = {
    {
QT_MOC_LITERAL(0, 0, 21) // "pqPropertyGroupWidget"
...
const QMetaObject pqPropertyGroupWidget::staticMetaObject = {
    { &pqPropertyWidget::staticMetaObject, qt_meta_stringdata_pqPropertyGroupWidget.data,
      qt_meta_data_pqPropertyGroupWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqPropertyGroupWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqPropertyGroupWidget.stringdata0))
