...
#include "../../../Qt/Components/pqSGPluginManager.h"
...
struct qt_meta_stringdata_pqSGPluginManager_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqSGPluginManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqSGPluginManager_t qt_meta_stringdata_pqSGPluginManager = {
    {
QT_MOC_LITERAL(0, 0, 17) // "pqSGPluginManager"
...
const QMetaObject pqSGPluginManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqSGPluginManager.data,
      qt_meta_data_pqSGPluginManager,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqSGPluginManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqSGPluginManager.stringdata0))
