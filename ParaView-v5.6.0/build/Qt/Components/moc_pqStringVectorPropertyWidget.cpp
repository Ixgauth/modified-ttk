...
#include "../../../Qt/Components/pqStringVectorPropertyWidget.h"
...
struct qt_meta_stringdata_pqStringVectorPropertyWidget_t {
    QByteArrayData data[1];
    char stringdata0[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqStringVectorPropertyWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqStringVectorPropertyWidget_t qt_meta_stringdata_pqStringVectorPropertyWidget = {
    {
QT_MOC_LITERAL(0, 0, 28) // "pqStringVectorPropertyWidget"
...
const QMetaObject pqStringVectorPropertyWidget::staticMetaObject = {
    { &pqPropertyWidget::staticMetaObject, qt_meta_stringdata_pqStringVectorPropertyWidget.data,
      qt_meta_data_pqStringVectorPropertyWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqStringVectorPropertyWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqStringVectorPropertyWidget.stringdata0))
