...
#include "../../../Qt/Components/pqTextureSelectorPropertyWidget.h"
...
struct qt_meta_stringdata_pqTextureSelectorPropertyWidget_t {
    QByteArrayData data[5];
    char stringdata0[64];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqTextureSelectorPropertyWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqTextureSelectorPropertyWidget_t qt_meta_stringdata_pqTextureSelectorPropertyWidget = {
    {
QT_MOC_LITERAL(0, 0, 31), // "pqTextureSelectorPropertyWidget"
QT_MOC_LITERAL(1, 32, 17), // "handleViewChanged"
QT_MOC_LITERAL(2, 50, 0), // ""
QT_MOC_LITERAL(3, 51, 7), // "pqView*"
QT_MOC_LITERAL(4, 59, 4) // "view"

    },
    "pqTextureSelectorPropertyWidget\0"
    "handleViewChanged\0\0pqView*\0view"
};
...
const QMetaObject pqTextureSelectorPropertyWidget::staticMetaObject = {
    { &pqPropertyWidget::staticMetaObject, qt_meta_stringdata_pqTextureSelectorPropertyWidget.data,
      qt_meta_data_pqTextureSelectorPropertyWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqTextureSelectorPropertyWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqTextureSelectorPropertyWidget.stringdata0))
