...
#include "../../../Qt/Core/pqContextView.h"
...
struct qt_meta_stringdata_pqContextView_t {
    QByteArrayData data[4];
    char stringdata0[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqContextView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqContextView_t qt_meta_stringdata_pqContextView = {
    {
QT_MOC_LITERAL(0, 0, 13), // "pqContextView"
QT_MOC_LITERAL(1, 14, 16), // "startInteraction"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 14) // "endInteraction"

    },
    "pqContextView\0startInteraction\0\0"
    "endInteraction"
};
...
const QMetaObject pqContextView::staticMetaObject = {
    { &pqView::staticMetaObject, qt_meta_stringdata_pqContextView.data,
      qt_meta_data_pqContextView,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqContextView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqContextView.stringdata0))
