...
#include "../../../Qt/Core/pqDisplayPolicy.h"
...
struct qt_meta_stringdata_pqDisplayPolicy_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqDisplayPolicy_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqDisplayPolicy_t qt_meta_stringdata_pqDisplayPolicy = {
    {
QT_MOC_LITERAL(0, 0, 15) // "pqDisplayPolicy"
...
const QMetaObject pqDisplayPolicy::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqDisplayPolicy.data,
      qt_meta_data_pqDisplayPolicy,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqDisplayPolicy::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqDisplayPolicy.stringdata0))
