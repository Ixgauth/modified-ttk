...
#include "../../../Qt/Core/pqFileDialogEventPlayer.h"
...
struct qt_meta_stringdata_pqFileDialogEventPlayer_t {
    QByteArrayData data[1];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqFileDialogEventPlayer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqFileDialogEventPlayer_t qt_meta_stringdata_pqFileDialogEventPlayer = {
    {
QT_MOC_LITERAL(0, 0, 23) // "pqFileDialogEventPlayer"
...
const QMetaObject pqFileDialogEventPlayer::staticMetaObject = {
    { &pqWidgetEventPlayer::staticMetaObject, qt_meta_stringdata_pqFileDialogEventPlayer.data,
      qt_meta_data_pqFileDialogEventPlayer,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqFileDialogEventPlayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqFileDialogEventPlayer.stringdata0))
