...
#include "../../../Qt/Core/pqFileDialogFilter.h"
...
struct qt_meta_stringdata_pqFileDialogFilter_t {
    QByteArrayData data[7];
    char stringdata0[72];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqFileDialogFilter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqFileDialogFilter_t qt_meta_stringdata_pqFileDialogFilter = {
    {
QT_MOC_LITERAL(0, 0, 18), // "pqFileDialogFilter"
QT_MOC_LITERAL(1, 19, 9), // "setFilter"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 6), // "filter"
QT_MOC_LITERAL(4, 37, 13), // "setShowHidden"
QT_MOC_LITERAL(5, 51, 6), // "hidden"
QT_MOC_LITERAL(6, 58, 13) // "getShowHidden"

    },
    "pqFileDialogFilter\0setFilter\0\0filter\0"
    "setShowHidden\0hidden\0getShowHidden"
};
...
const QMetaObject pqFileDialogFilter::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_pqFileDialogFilter.data,
      qt_meta_data_pqFileDialogFilter,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqFileDialogFilter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqFileDialogFilter.stringdata0))
