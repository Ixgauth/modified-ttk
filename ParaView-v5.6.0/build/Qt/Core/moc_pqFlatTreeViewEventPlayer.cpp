...
#include "../../../Qt/Core/pqFlatTreeViewEventPlayer.h"
...
struct qt_meta_stringdata_pqFlatTreeViewEventPlayer_t {
    QByteArrayData data[1];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqFlatTreeViewEventPlayer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqFlatTreeViewEventPlayer_t qt_meta_stringdata_pqFlatTreeViewEventPlayer = {
    {
QT_MOC_LITERAL(0, 0, 25) // "pqFlatTreeViewEventPlayer"
...
const QMetaObject pqFlatTreeViewEventPlayer::staticMetaObject = {
    { &pqWidgetEventPlayer::staticMetaObject, qt_meta_stringdata_pqFlatTreeViewEventPlayer.data,
      qt_meta_data_pqFlatTreeViewEventPlayer,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqFlatTreeViewEventPlayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqFlatTreeViewEventPlayer.stringdata0))
