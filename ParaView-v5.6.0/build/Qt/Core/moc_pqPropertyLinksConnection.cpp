...
#include "../../../Qt/Core/pqPropertyLinksConnection.h"
...
struct qt_meta_stringdata_pqPropertyLinksConnection_t {
    QByteArrayData data[7];
    char stringdata0[143];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqPropertyLinksConnection_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqPropertyLinksConnection_t qt_meta_stringdata_pqPropertyLinksConnection = {
    {
QT_MOC_LITERAL(0, 0, 25), // "pqPropertyLinksConnection"
QT_MOC_LITERAL(1, 26, 18), // "qtpropertyModified"
QT_MOC_LITERAL(2, 45, 0), // ""
QT_MOC_LITERAL(3, 46, 18), // "smpropertyModified"
QT_MOC_LITERAL(4, 65, 31), // "copyValuesFromServerManagerToQt"
QT_MOC_LITERAL(5, 97, 13), // "use_unchecked"
QT_MOC_LITERAL(6, 111, 31) // "copyValuesFromQtToServerManager"

    },
    "pqPropertyLinksConnection\0qtpropertyModified\0"
    "\0smpropertyModified\0copyValuesFromServerManagerToQt\0"
    "use_unchecked\0copyValuesFromQtToServerManager"
};
...
void pqPropertyLinksConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (pqPropertyLinksConnection::*_t)();
...
const QMetaObject pqPropertyLinksConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqPropertyLinksConnection.data,
      qt_meta_data_pqPropertyLinksConnection,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqPropertyLinksConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqPropertyLinksConnection.stringdata0))
