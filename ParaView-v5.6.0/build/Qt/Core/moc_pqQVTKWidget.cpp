...
#include "../../../Qt/Core/pqQVTKWidget.h"
...
struct qt_meta_stringdata_pqQVTKWidget_t {
    QByteArrayData data[6];
    char stringdata0[57];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqQVTKWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqQVTKWidget_t qt_meta_stringdata_pqQVTKWidget = {
    {
QT_MOC_LITERAL(0, 0, 12), // "pqQVTKWidget"
QT_MOC_LITERAL(1, 13, 17), // "paintMousePointer"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 1), // "x"
QT_MOC_LITERAL(4, 34, 1), // "y"
QT_MOC_LITERAL(5, 36, 20) // "updateSizeProperties"

    },
    "pqQVTKWidget\0paintMousePointer\0\0x\0y\0"
...
const QMetaObject pqQVTKWidget::staticMetaObject = {
    { &pqQVTKWidgetBase::staticMetaObject, qt_meta_stringdata_pqQVTKWidget.data,
      qt_meta_data_pqQVTKWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqQVTKWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqQVTKWidget.stringdata0))
        return static_cast<void*>(this);
    return pqQVTKWidgetBase::qt_metacast(_clname);
}

int pqQVTKWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = pqQVTKWidgetBase::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
