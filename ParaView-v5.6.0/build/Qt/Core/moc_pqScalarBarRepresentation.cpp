...
#include "../../../Qt/Core/pqScalarBarRepresentation.h"
...
struct qt_meta_stringdata_pqScalarBarRepresentation_t {
    QByteArrayData data[4];
    char stringdata0[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqScalarBarRepresentation_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqScalarBarRepresentation_t qt_meta_stringdata_pqScalarBarRepresentation = {
    {
QT_MOC_LITERAL(0, 0, 25), // "pqScalarBarRepresentation"
QT_MOC_LITERAL(1, 26, 16), // "startInteraction"
QT_MOC_LITERAL(2, 43, 0), // ""
QT_MOC_LITERAL(3, 44, 14) // "endInteraction"

    },
    "pqScalarBarRepresentation\0startInteraction\0"
    "\0endInteraction"
};
...
const QMetaObject pqScalarBarRepresentation::staticMetaObject = {
    { &pqRepresentation::staticMetaObject, qt_meta_stringdata_pqScalarBarRepresentation.data,
      qt_meta_data_pqScalarBarRepresentation,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqScalarBarRepresentation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqScalarBarRepresentation.stringdata0))
