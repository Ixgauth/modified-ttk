...
struct qt_meta_stringdata_pqSettings_t {
    QByteArrayData data[3];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqSettings_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqSettings_t qt_meta_stringdata_pqSettings = {
    {
QT_MOC_LITERAL(0, 0, 10), // "pqSettings"
QT_MOC_LITERAL(1, 11, 8), // "modified"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "pqSettings\0modified\0"
};
...
void pqSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (pqSettings::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&pqSettings::modified)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject pqSettings::staticMetaObject = {
    { &QSettings::staticMetaObject, qt_meta_stringdata_pqSettings.data,
      qt_meta_data_pqSettings,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqSettings.stringdata0))
