...
#include "../../../Qt/Core/pqXYChartView.h"
...
struct qt_meta_stringdata_pqXYChartView_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqXYChartView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqXYChartView_t qt_meta_stringdata_pqXYChartView = {
    {
QT_MOC_LITERAL(0, 0, 13) // "pqXYChartView"
...
const QMetaObject pqXYChartView::staticMetaObject = {
    { &pqContextView::staticMetaObject, qt_meta_stringdata_pqXYChartView.data,
      qt_meta_data_pqXYChartView,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqXYChartView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqXYChartView.stringdata0))
