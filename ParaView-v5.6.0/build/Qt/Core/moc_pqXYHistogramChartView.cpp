...
#include "../../../Qt/Core/pqXYHistogramChartView.h"
...
struct qt_meta_stringdata_pqXYHistogramChartView_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqXYHistogramChartView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqXYHistogramChartView_t qt_meta_stringdata_pqXYHistogramChartView = {
    {
QT_MOC_LITERAL(0, 0, 22) // "pqXYHistogramChartView"
...
const QMetaObject pqXYHistogramChartView::staticMetaObject = {
    { &pqContextView::staticMetaObject, qt_meta_stringdata_pqXYHistogramChartView.data,
      qt_meta_data_pqXYHistogramChartView,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqXYHistogramChartView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqXYHistogramChartView.stringdata0))
