...
#include "../../../Qt/Python/pqPythonDebugLeaksView.h"
...
struct qt_meta_stringdata_pqPythonDebugLeaksView_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqPythonDebugLeaksView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqPythonDebugLeaksView_t qt_meta_stringdata_pqPythonDebugLeaksView = {
    {
QT_MOC_LITERAL(0, 0, 22) // "pqPythonDebugLeaksView"
...
const QMetaObject pqPythonDebugLeaksView::staticMetaObject = {
    { &vtkQtDebugLeaksView::staticMetaObject, qt_meta_stringdata_pqPythonDebugLeaksView.data,
      qt_meta_data_pqPythonDebugLeaksView,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqPythonDebugLeaksView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqPythonDebugLeaksView.stringdata0))
