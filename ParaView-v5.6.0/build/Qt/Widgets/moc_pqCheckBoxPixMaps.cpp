...
#include "../../../Qt/Widgets/pqCheckBoxPixMaps.h"
...
struct qt_meta_stringdata_pqCheckBoxPixMaps_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqCheckBoxPixMaps_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqCheckBoxPixMaps_t qt_meta_stringdata_pqCheckBoxPixMaps = {
    {
QT_MOC_LITERAL(0, 0, 17) // "pqCheckBoxPixMaps"
...
const QMetaObject pqCheckBoxPixMaps::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqCheckBoxPixMaps.data,
      qt_meta_data_pqCheckBoxPixMaps,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqCheckBoxPixMaps::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqCheckBoxPixMaps.stringdata0))
