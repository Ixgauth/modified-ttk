...
#include "../../../Qt/Widgets/pqColorDialogEventTranslator.h"
...
struct qt_meta_stringdata_pqColorDialogEventTranslator_t {
    QByteArrayData data[4];
    char stringdata0[55];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqColorDialogEventTranslator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqColorDialogEventTranslator_t qt_meta_stringdata_pqColorDialogEventTranslator = {
    {
QT_MOC_LITERAL(0, 0, 28), // "pqColorDialogEventTranslator"
QT_MOC_LITERAL(1, 29, 13), // "onColorChosen"
QT_MOC_LITERAL(2, 43, 0), // ""
QT_MOC_LITERAL(3, 44, 10) // "onFinished"

    },
    "pqColorDialogEventTranslator\0onColorChosen\0"
    "\0onFinished"
};
...
const QMetaObject pqColorDialogEventTranslator::staticMetaObject = {
    { &pqWidgetEventTranslator::staticMetaObject, qt_meta_stringdata_pqColorDialogEventTranslator.data,
      qt_meta_data_pqColorDialogEventTranslator,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqColorDialogEventTranslator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqColorDialogEventTranslator.stringdata0))
