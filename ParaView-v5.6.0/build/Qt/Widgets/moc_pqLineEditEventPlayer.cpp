...
#include "../../../Qt/Widgets/pqLineEditEventPlayer.h"
...
struct qt_meta_stringdata_pqLineEditEventPlayer_t {
    QByteArrayData data[1];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqLineEditEventPlayer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqLineEditEventPlayer_t qt_meta_stringdata_pqLineEditEventPlayer = {
    {
QT_MOC_LITERAL(0, 0, 21) // "pqLineEditEventPlayer"
...
const QMetaObject pqLineEditEventPlayer::staticMetaObject = {
    { &pqAbstractStringEventPlayer::staticMetaObject, qt_meta_stringdata_pqLineEditEventPlayer.data,
      qt_meta_data_pqLineEditEventPlayer,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqLineEditEventPlayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqLineEditEventPlayer.stringdata0))
