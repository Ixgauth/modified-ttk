...
#include "../../../Qt/Widgets/pqListWidgetCheckHelper.h"
...
struct qt_meta_stringdata_pqListWidgetCheckHelper_t {
    QByteArrayData data[6];
    char stringdata0[75];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqListWidgetCheckHelper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqListWidgetCheckHelper_t qt_meta_stringdata_pqListWidgetCheckHelper = {
    {
QT_MOC_LITERAL(0, 0, 23), // "pqListWidgetCheckHelper"
QT_MOC_LITERAL(1, 24, 13), // "onItemClicked"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(4, 56, 4), // "item"
QT_MOC_LITERAL(5, 61, 13) // "onItemPressed"

    },
    "pqListWidgetCheckHelper\0onItemClicked\0"
    "\0QListWidgetItem*\0item\0onItemPressed"
};
...
const QMetaObject pqListWidgetCheckHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqListWidgetCheckHelper.data,
      qt_meta_data_pqListWidgetCheckHelper,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqListWidgetCheckHelper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqListWidgetCheckHelper.stringdata0))
