...
#include "../../../Qt/Widgets/pqQuickLaunchDialog.h"
...
struct qt_meta_stringdata_pqQuickLaunchDialog_t {
    QByteArrayData data[4];
    char stringdata0[46];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqQuickLaunchDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqQuickLaunchDialog_t qt_meta_stringdata_pqQuickLaunchDialog = {
    {
QT_MOC_LITERAL(0, 0, 19), // "pqQuickLaunchDialog"
QT_MOC_LITERAL(1, 20, 6), // "accept"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 17) // "currentRowChanged"

    },
    "pqQuickLaunchDialog\0accept\0\0"
    "currentRowChanged"
};
...
const QMetaObject pqQuickLaunchDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_pqQuickLaunchDialog.data,
      qt_meta_data_pqQuickLaunchDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqQuickLaunchDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqQuickLaunchDialog.stringdata0))
