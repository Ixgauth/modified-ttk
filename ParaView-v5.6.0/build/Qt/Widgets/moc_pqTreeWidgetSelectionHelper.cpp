...
#include "../../../Qt/Widgets/pqTreeWidgetSelectionHelper.h"
...
struct qt_meta_stringdata_pqTreeWidgetSelectionHelper_t {
    QByteArrayData data[7];
    char stringdata0[88];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqTreeWidgetSelectionHelper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqTreeWidgetSelectionHelper_t qt_meta_stringdata_pqTreeWidgetSelectionHelper = {
    {
QT_MOC_LITERAL(0, 0, 27), // "pqTreeWidgetSelectionHelper"
QT_MOC_LITERAL(1, 28, 13), // "onItemPressed"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 16), // "QTreeWidgetItem*"
QT_MOC_LITERAL(4, 60, 4), // "item"
QT_MOC_LITERAL(5, 65, 6), // "column"
QT_MOC_LITERAL(6, 72, 15) // "showContextMenu"

    },
    "pqTreeWidgetSelectionHelper\0onItemPressed\0"
...
const QMetaObject pqTreeWidgetSelectionHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqTreeWidgetSelectionHelper.data,
      qt_meta_data_pqTreeWidgetSelectionHelper,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqTreeWidgetSelectionHelper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqTreeWidgetSelectionHelper.stringdata0))
