...
#include "../../../../../ThirdParty/QtTesting/vtkqttesting/Examples/TestingDemo.h"
...
struct qt_meta_stringdata_TestingDemo_t {
    QByteArrayData data[5];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TestingDemo_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TestingDemo_t qt_meta_stringdata_TestingDemo = {
    {
QT_MOC_LITERAL(0, 0, 11), // "TestingDemo"
QT_MOC_LITERAL(1, 12, 6), // "record"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 4), // "play"
QT_MOC_LITERAL(4, 25, 5) // "popup"

    },
    "TestingDemo\0record\0\0play\0popup"
};
...
const QMetaObject TestingDemo::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_TestingDemo.data,
      qt_meta_data_TestingDemo,  qt_static_metacall, nullptr, nullptr}
};
...
void *TestingDemo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestingDemo.stringdata0))
