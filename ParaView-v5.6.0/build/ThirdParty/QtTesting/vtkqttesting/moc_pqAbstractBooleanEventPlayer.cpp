...
#include "../../../../ThirdParty/QtTesting/vtkqttesting/pqAbstractBooleanEventPlayer.h"
...
struct qt_meta_stringdata_pqAbstractBooleanEventPlayer_t {
    QByteArrayData data[1];
    char stringdata0[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqAbstractBooleanEventPlayer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqAbstractBooleanEventPlayer_t qt_meta_stringdata_pqAbstractBooleanEventPlayer = {
    {
QT_MOC_LITERAL(0, 0, 28) // "pqAbstractBooleanEventPlayer"
...
const QMetaObject pqAbstractBooleanEventPlayer::staticMetaObject = {
    { &pqWidgetEventPlayer::staticMetaObject, qt_meta_stringdata_pqAbstractBooleanEventPlayer.data,
      qt_meta_data_pqAbstractBooleanEventPlayer,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqAbstractBooleanEventPlayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqAbstractBooleanEventPlayer.stringdata0))
