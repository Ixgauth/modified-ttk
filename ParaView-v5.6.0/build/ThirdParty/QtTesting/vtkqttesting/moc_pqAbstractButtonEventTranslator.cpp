...
#include "../../../../ThirdParty/QtTesting/vtkqttesting/pqAbstractButtonEventTranslator.h"
...
struct qt_meta_stringdata_pqAbstractButtonEventTranslator_t {
    QByteArrayData data[1];
    char stringdata0[32];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqAbstractButtonEventTranslator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqAbstractButtonEventTranslator_t qt_meta_stringdata_pqAbstractButtonEventTranslator = {
    {
QT_MOC_LITERAL(0, 0, 31) // "pqAbstractButtonEventTranslator"
...
const QMetaObject pqAbstractButtonEventTranslator::staticMetaObject = {
    { &pqWidgetEventTranslator::staticMetaObject, qt_meta_stringdata_pqAbstractButtonEventTranslator.data,
      qt_meta_data_pqAbstractButtonEventTranslator,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqAbstractButtonEventTranslator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqAbstractButtonEventTranslator.stringdata0))
