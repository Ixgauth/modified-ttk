...
#include "../../../../ThirdParty/QtTesting/vtkqttesting/pqAbstractDoubleEventPlayer.h"
...
struct qt_meta_stringdata_pqAbstractDoubleEventPlayer_t {
    QByteArrayData data[1];
    char stringdata0[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqAbstractDoubleEventPlayer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqAbstractDoubleEventPlayer_t qt_meta_stringdata_pqAbstractDoubleEventPlayer = {
    {
QT_MOC_LITERAL(0, 0, 27) // "pqAbstractDoubleEventPlayer"
...
const QMetaObject pqAbstractDoubleEventPlayer::staticMetaObject = {
    { &pqWidgetEventPlayer::staticMetaObject, qt_meta_stringdata_pqAbstractDoubleEventPlayer.data,
      qt_meta_data_pqAbstractDoubleEventPlayer,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqAbstractDoubleEventPlayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqAbstractDoubleEventPlayer.stringdata0))
