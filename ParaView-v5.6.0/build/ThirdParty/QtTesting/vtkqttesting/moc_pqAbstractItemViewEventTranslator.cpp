...
#include "../../../../ThirdParty/QtTesting/vtkqttesting/pqAbstractItemViewEventTranslator.h"
...
struct qt_meta_stringdata_pqAbstractItemViewEventTranslator_t {
    QByteArrayData data[1];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqAbstractItemViewEventTranslator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqAbstractItemViewEventTranslator_t qt_meta_stringdata_pqAbstractItemViewEventTranslator = {
    {
QT_MOC_LITERAL(0, 0, 33) // "pqAbstractItemViewEventTransl..."
...
const QMetaObject pqAbstractItemViewEventTranslator::staticMetaObject = {
    { &pqWidgetEventTranslator::staticMetaObject, qt_meta_stringdata_pqAbstractItemViewEventTranslator.data,
      qt_meta_data_pqAbstractItemViewEventTranslator,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqAbstractItemViewEventTranslator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqAbstractItemViewEventTranslator.stringdata0))
