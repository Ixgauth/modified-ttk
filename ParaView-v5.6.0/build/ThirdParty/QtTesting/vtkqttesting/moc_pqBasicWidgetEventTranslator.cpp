...
#include "../../../../ThirdParty/QtTesting/vtkqttesting/pqBasicWidgetEventTranslator.h"
...
struct qt_meta_stringdata_pqBasicWidgetEventTranslator_t {
    QByteArrayData data[1];
    char stringdata0[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqBasicWidgetEventTranslator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqBasicWidgetEventTranslator_t qt_meta_stringdata_pqBasicWidgetEventTranslator = {
    {
QT_MOC_LITERAL(0, 0, 28) // "pqBasicWidgetEventTranslator"
...
const QMetaObject pqBasicWidgetEventTranslator::staticMetaObject = {
    { &pqWidgetEventTranslator::staticMetaObject, qt_meta_stringdata_pqBasicWidgetEventTranslator.data,
      qt_meta_data_pqBasicWidgetEventTranslator,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqBasicWidgetEventTranslator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqBasicWidgetEventTranslator.stringdata0))
