...
#include "../../../../ThirdParty/QtTesting/vtkqttesting/pqDoubleSpinBoxEventTranslator.h"
...
struct qt_meta_stringdata_pqDoubleSpinBoxEventTranslator_t {
    QByteArrayData data[5];
    char stringdata0[66];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqDoubleSpinBoxEventTranslator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqDoubleSpinBoxEventTranslator_t qt_meta_stringdata_pqDoubleSpinBoxEventTranslator = {
    {
QT_MOC_LITERAL(0, 0, 30), // "pqDoubleSpinBoxEventTranslator"
QT_MOC_LITERAL(1, 31, 11), // "onDestroyed"
QT_MOC_LITERAL(2, 43, 0), // ""
QT_MOC_LITERAL(3, 44, 14), // "onValueChanged"
QT_MOC_LITERAL(4, 59, 6) // "number"

    },
    "pqDoubleSpinBoxEventTranslator\0"
    "onDestroyed\0\0onValueChanged\0number"
};
...
const QMetaObject pqDoubleSpinBoxEventTranslator::staticMetaObject = {
    { &pqWidgetEventTranslator::staticMetaObject, qt_meta_stringdata_pqDoubleSpinBoxEventTranslator.data,
      qt_meta_data_pqDoubleSpinBoxEventTranslator,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqDoubleSpinBoxEventTranslator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqDoubleSpinBoxEventTranslator.stringdata0))
