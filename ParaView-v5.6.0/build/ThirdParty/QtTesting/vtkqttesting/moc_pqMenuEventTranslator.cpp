...
#include "../../../../ThirdParty/QtTesting/vtkqttesting/pqMenuEventTranslator.h"
...
struct qt_meta_stringdata_pqMenuEventTranslator_t {
    QByteArrayData data[1];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqMenuEventTranslator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqMenuEventTranslator_t qt_meta_stringdata_pqMenuEventTranslator = {
    {
QT_MOC_LITERAL(0, 0, 21) // "pqMenuEventTranslator"
...
const QMetaObject pqMenuEventTranslator::staticMetaObject = {
    { &pqWidgetEventTranslator::staticMetaObject, qt_meta_stringdata_pqMenuEventTranslator.data,
      qt_meta_data_pqMenuEventTranslator,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqMenuEventTranslator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqMenuEventTranslator.stringdata0))
