...
#include "../../../../ThirdParty/QtTesting/vtkqttesting/pqNativeFileDialogEventPlayer.h"
...
struct qt_meta_stringdata_pqNativeFileDialogEventPlayer_t {
    QByteArrayData data[4];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqNativeFileDialogEventPlayer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqNativeFileDialogEventPlayer_t qt_meta_stringdata_pqNativeFileDialogEventPlayer = {
    {
QT_MOC_LITERAL(0, 0, 29), // "pqNativeFileDialogEventPlayer"
QT_MOC_LITERAL(1, 30, 5), // "start"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 4) // "stop"

    },
    "pqNativeFileDialogEventPlayer\0start\0"
    "\0stop"
};
...
const QMetaObject pqNativeFileDialogEventPlayer::staticMetaObject = {
    { &pqWidgetEventPlayer::staticMetaObject, qt_meta_stringdata_pqNativeFileDialogEventPlayer.data,
      qt_meta_data_pqNativeFileDialogEventPlayer,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqNativeFileDialogEventPlayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqNativeFileDialogEventPlayer.stringdata0))
