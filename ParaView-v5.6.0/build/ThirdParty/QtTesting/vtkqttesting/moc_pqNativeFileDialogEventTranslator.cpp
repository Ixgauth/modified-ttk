...
#include "../../../../ThirdParty/QtTesting/vtkqttesting/pqNativeFileDialogEventTranslator.h"
...
struct qt_meta_stringdata_pqNativeFileDialogEventTranslator_t {
    QByteArrayData data[4];
    char stringdata0[46];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqNativeFileDialogEventTranslator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqNativeFileDialogEventTranslator_t qt_meta_stringdata_pqNativeFileDialogEventTranslator = {
    {
QT_MOC_LITERAL(0, 0, 33), // "pqNativeFileDialogEventTransl..."
QT_MOC_LITERAL(1, 34, 5), // "start"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 4) // "stop"

    },
    "pqNativeFileDialogEventTranslator\0"
    "start\0\0stop"
};
...
const QMetaObject pqNativeFileDialogEventTranslator::staticMetaObject = {
    { &pqWidgetEventTranslator::staticMetaObject, qt_meta_stringdata_pqNativeFileDialogEventTranslator.data,
      qt_meta_data_pqNativeFileDialogEventTranslator,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqNativeFileDialogEventTranslator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqNativeFileDialogEventTranslator.stringdata0))
