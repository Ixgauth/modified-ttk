...
#include "../../../../ThirdParty/QtTesting/vtkqttesting/pqThreadedEventSource.h"
...
struct qt_meta_stringdata_pqThreadedEventSource_t {
    QByteArrayData data[6];
    char stringdata0[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqThreadedEventSource_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqThreadedEventSource_t qt_meta_stringdata_pqThreadedEventSource = {
    {
QT_MOC_LITERAL(0, 0, 21), // "pqThreadedEventSource"
QT_MOC_LITERAL(1, 22, 10), // "relayEvent"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 6), // "object"
QT_MOC_LITERAL(4, 41, 7), // "command"
QT_MOC_LITERAL(5, 49, 9) // "arguments"

    },
    "pqThreadedEventSource\0relayEvent\0\0"
    "object\0command\0arguments"
};
...
const QMetaObject pqThreadedEventSource::staticMetaObject = {
    { &pqEventSource::staticMetaObject, qt_meta_stringdata_pqThreadedEventSource.data,
      qt_meta_data_pqThreadedEventSource,  qt_static_metacall, nullptr, nullptr}
};
...
void *pqThreadedEventSource::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqThreadedEventSource.stringdata0))
