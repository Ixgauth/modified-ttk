...
#define vtksys_SHARED_FORWARD_EXE_BUILD "/home/ian/ttk/ParaView-v5.6.0/build/bin/vtkProbeOpenGLVersion"
#define vtksys_SHARED_FORWARD_EXE_INSTALL "../lib/vtkProbeOpenGLVersion"
