...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkAMRFragmentIntegration(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkAMRFragmentIntegration_ClassNew(); }
...
static const char *PyvtkAMRFragmentIntegration_Doc =
  "vtkAMRFragmentIntegration - Generates fragment analysis from an amr\nvolume and a previously run contour on that volume\n\n"
...
static PyObject *
PyvtkAMRFragmentIntegration_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkAMRFragmentIntegration::IsTypeOf(temp0);
...
static PyMethodDef PyvtkAMRFragmentIntegration_Methods[] = {
  {"IsTypeOf", PyvtkAMRFragmentIntegration_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkAMRFragmentIntegration_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkAMRFragmentIntegration_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkAMRFragmentIntegration\nC++: static vtkAMRFragmentIntegration *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkAMRFragmentIntegration_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkAMRFragmentIntegration\nC++: vtkAMRFragmentIntegration *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkAMRFragmentIntegration_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVVTKExtensionsDefaultPython.vtkAMRFragmentIntegration", // tp_name
  ...
  PyvtkAMRFragmentIntegration_Doc, // tp_doc
...
PyObject *PyvtkAMRFragmentIntegration_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkAMRFragmentIntegration_Type, PyvtkAMRFragmentIntegration_Methods,
    "vtkAMRFragmentIntegration",
 &PyvtkAMRFragmentIntegration_StaticNew);

  PyTypeObject *pytype = &PyvtkAMRFragmentIntegration_Type;
...
{
  PyObject *o;
  o = PyvtkAMRFragmentIntegration_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkAMRFragmentIntegration", o) != 0)
  {
    Py_DECREF(o);
  }
