...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkAppendRectilinearGrid(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkAppendRectilinearGrid_ClassNew(); }
...
static PyObject *
PyvtkAppendRectilinearGrid_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkAppendRectilinearGrid::IsTypeOf(temp0);
...
static PyMethodDef PyvtkAppendRectilinearGrid_Methods[] = {
  {"IsTypeOf", PyvtkAppendRectilinearGrid_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkAppendRectilinearGrid_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkAppendRectilinearGrid_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkAppendRectilinearGrid\nC++: static vtkAppendRectilinearGrid *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkAppendRectilinearGrid_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkAppendRectilinearGrid\nC++: vtkAppendRectilinearGrid *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkAppendRectilinearGrid_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVVTKExtensionsDefaultPython.vtkAppendRectilinearGrid", // tp_name
  ...
  PyvtkAppendRectilinearGrid_Doc, // tp_doc
...
PyObject *PyvtkAppendRectilinearGrid_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkAppendRectilinearGrid_Type, PyvtkAppendRectilinearGrid_Methods,
    "vtkAppendRectilinearGrid",
 &PyvtkAppendRectilinearGrid_StaticNew);

  PyTypeObject *pytype = &PyvtkAppendRectilinearGrid_Type;
...
{
  PyObject *o;
  o = PyvtkAppendRectilinearGrid_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkAppendRectilinearGrid", o) != 0)
  {
    Py_DECREF(o);
  }
