...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkCompleteArrays(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkCompleteArrays_ClassNew(); }
...
static const char *PyvtkCompleteArrays_Doc =
  ...
  "if there are no cells or points in that partition. This filter can\n"
  "also handle vtkTable by letting them pass through it without\n"
  "modification.\n\n";


static PyObject *
PyvtkCompleteArrays_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkCompleteArrays::IsTypeOf(temp0);
...
static PyMethodDef PyvtkCompleteArrays_Methods[] = {
  {"IsTypeOf", PyvtkCompleteArrays_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkCompleteArrays_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkCompleteArrays_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkCompleteArrays\nC++: static vtkCompleteArrays *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkCompleteArrays_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkCompleteArrays\nC++: vtkCompleteArrays *NewInstance()\n\n"},
  {"SetController", PyvtkCompleteArrays_SetController, METH_VARARGS,
   "V.SetController(vtkMultiProcessController)\nC++: void SetController(vtkMultiProcessController *controller)\n\nThe user can set the controller used for inter-process\ncommunication.\n"},
  {"GetController", PyvtkCompleteArrays_GetController, METH_VARARGS,
   "V.GetController() -> vtkMultiProcessController\nC++: virtual vtkMultiProcessController *GetController()\n\nThe user can set the controller used for inter-process\ncommunication.\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkCompleteArrays_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVClientServerCoreCorePython.vtkCompleteArrays", // tp_name
  ...
  PyvtkCompleteArrays_Doc, // tp_doc
...
PyObject *PyvtkCompleteArrays_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkCompleteArrays_Type, PyvtkCompleteArrays_Methods,
    "vtkCompleteArrays",
 &PyvtkCompleteArrays_StaticNew);

  PyTypeObject *pytype = &PyvtkCompleteArrays_Type;
...
{
  PyObject *o;
  o = PyvtkCompleteArrays_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkCompleteArrays", o) != 0)
  {
    Py_DECREF(o);
  }
