...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkExtractSelectionRange(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkExtractSelectionRange_ClassNew(); }
...
static PyObject *
PyvtkExtractSelectionRange_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkExtractSelectionRange::IsTypeOf(temp0);
...
static PyMethodDef PyvtkExtractSelectionRange_Methods[] = {
  {"IsTypeOf", PyvtkExtractSelectionRange_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkExtractSelectionRange_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkExtractSelectionRange_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkExtractSelectionRange\nC++: static vtkExtractSelectionRange *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkExtractSelectionRange_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkExtractSelectionRange\nC++: vtkExtractSelectionRange *NewInstance()\n\n"},
  {"SetArrayName", PyvtkExtractSelectionRange_SetArrayName, METH_VARARGS,
   "V.SetArrayName(string)\nC++: virtual void SetArrayName(const char *_arg)\n\nSet the name of the array used to compute the range.\n"},
  {"GetArrayName", PyvtkExtractSelectionRange_GetArrayName, METH_VARARGS,
   "V.GetArrayName() -> string\nC++: virtual char *GetArrayName()\n\nSet the name of the array used to compute the range.\n"},
  {"SetFieldType", PyvtkExtractSelectionRange_SetFieldType, METH_VARARGS,
   "V.SetFieldType(int)\nC++: virtual void SetFieldType(int _arg)\n\nSet/Get the field type of the selection.\n"},
  {"GetFieldType", PyvtkExtractSelectionRange_GetFieldType, METH_VARARGS,
   "V.GetFieldType() -> int\nC++: virtual int GetFieldType()\n\nSet/Get the field type of the selection.\n"},
  {"SetComponent", PyvtkExtractSelectionRange_SetComponent, METH_VARARGS,
   "V.SetComponent(int)\nC++: virtual void SetComponent(int _arg)\n\nSet/Get the component used to compute the range.\n"},
  {"GetComponent", PyvtkExtractSelectionRange_GetComponent, METH_VARARGS,
   "V.GetComponent() -> int\nC++: virtual int GetComponent()\n\nSet/Get the component used to compute the range.\n"},
  {"GetRange", PyvtkExtractSelectionRange_GetRange, METH_VARARGS,
   "V.GetRange() -> (float, float)\nC++: double *GetRange()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkExtractSelectionRange_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVVTKExtensionsDefaultPython.vtkExtractSelectionRange", // tp_name
  ...
  PyvtkExtractSelectionRange_Doc, // tp_doc
...
PyObject *PyvtkExtractSelectionRange_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkExtractSelectionRange_Type, PyvtkExtractSelectionRange_Methods,
    "vtkExtractSelectionRange",
 &PyvtkExtractSelectionRange_StaticNew);

  PyTypeObject *pytype = &PyvtkExtractSelectionRange_Type;
...
{
  PyObject *o;
  o = PyvtkExtractSelectionRange_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkExtractSelectionRange", o) != 0)
  {
    Py_DECREF(o);
  }
