...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkFlashContour(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkFlashContour_ClassNew(); }
...
static PyObject *
PyvtkFlashContour_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkFlashContour::IsTypeOf(temp0);
...
static PyMethodDef PyvtkFlashContour_Methods[] = {
  {"IsTypeOf", PyvtkFlashContour_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkFlashContour_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkFlashContour_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkFlashContour\nC++: static vtkFlashContour *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkFlashContour_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkFlashContour\nC++: vtkFlashContour *NewInstance()\n\n"},
  {"SetIsoValue", PyvtkFlashContour_SetIsoValue, METH_VARARGS,
   "V.SetIsoValue(float)\nC++: virtual void SetIsoValue(double _arg)\n\n"},
  {"GetIsoValue", PyvtkFlashContour_GetIsoValue, METH_VARARGS,
   "V.GetIsoValue() -> float\nC++: virtual double GetIsoValue()\n\n"},
  {"SetPassAttribute", PyvtkFlashContour_SetPassAttribute, METH_VARARGS,
   "V.SetPassAttribute(string)\nC++: virtual void SetPassAttribute(const char *_arg)\n\n"},
  {"GetPassAttribute", PyvtkFlashContour_GetPassAttribute, METH_VARARGS,
   "V.GetPassAttribute() -> string\nC++: virtual char *GetPassAttribute()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkFlashContour_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVVTKExtensionsDefaultPython.vtkFlashContour", // tp_name
...
PyObject *PyvtkFlashContour_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkFlashContour_Type, PyvtkFlashContour_Methods,
    "vtkFlashContour",
 &PyvtkFlashContour_StaticNew);

  PyTypeObject *pytype = &PyvtkFlashContour_Type;
...
{
  PyObject *o;
  o = PyvtkFlashContour_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkFlashContour", o) != 0)
  {
    Py_DECREF(o);
  }
