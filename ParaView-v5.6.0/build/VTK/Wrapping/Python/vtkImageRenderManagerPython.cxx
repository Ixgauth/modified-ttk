...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkImageRenderManager(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkImageRenderManager_ClassNew(); }
...
static PyObject *
PyvtkImageRenderManager_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkImageRenderManager::IsTypeOf(temp0);
...
static PyMethodDef PyvtkImageRenderManager_Methods[] = {
  {"IsTypeOf", PyvtkImageRenderManager_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkImageRenderManager_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkImageRenderManager_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkImageRenderManager\nC++: static vtkImageRenderManager *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkImageRenderManager_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkImageRenderManager\nC++: vtkImageRenderManager *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkImageRenderManager_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkRenderingParallelPython.vtkImageRenderManager", // tp_name
  ...
  PyvtkImageRenderManager_Doc, // tp_doc
...
PyObject *PyvtkImageRenderManager_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkImageRenderManager_Type, PyvtkImageRenderManager_Methods,
    "vtkImageRenderManager",
 &PyvtkImageRenderManager_StaticNew);

  PyTypeObject *pytype = &PyvtkImageRenderManager_Type;
...
{
  PyObject *o;
  o = PyvtkImageRenderManager_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkImageRenderManager", o) != 0)
  {
    Py_DECREF(o);
  }
