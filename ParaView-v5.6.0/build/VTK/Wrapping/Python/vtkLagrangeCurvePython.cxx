...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkLagrangeCurve(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkLagrangeCurve_ClassNew(); }
...
static PyObject *
PyvtkLagrangeCurve_IsTypeOf(PyObject *, PyObject *args)
{
...
static PyObject *
PyvtkLagrangeCurve_SafeDownCast(PyObject *, PyObject *args)
{
...
static PyObject *
PyvtkLagrangeCurve_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetCellDimension() :
      op->vtkLagrangeCurve::GetCellDimension());
...
static PyObject *
PyvtkLagrangeCurve_RequiresInitialization(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::RequiresInitialization());
...
static PyObject *
PyvtkLagrangeCurve_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfEdges() :
      op->vtkLagrangeCurve::GetNumberOfEdges());
...
static PyObject *
PyvtkLagrangeCurve_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfFaces() :
      op->vtkLagrangeCurve::GetNumberOfFaces());
...
static PyObject *
PyvtkLagrangeCurve_GetEdge(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    vtkCell *tempr = (ap.IsBound() ?
      op->GetEdge(temp0) :
      op->vtkLagrangeCurve::GetEdge(temp0));
...
static PyObject *
PyvtkLagrangeCurve_GetFace(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    vtkCell *tempr = (ap.IsBound() ?
      op->GetFace(temp0) :
      op->vtkLagrangeCurve::GetFace(temp0));
...
static PyObject *
PyvtkLagrangeCurve_Initialize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    {
      op->vtkLagrangeCurve::Initialize();
    }
...
static PyObject *
PyvtkLagrangeCurve_CellBoundary(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkIdList"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::CellBoundary(temp0, temp1, temp2));
...
static PyObject *
PyvtkLagrangeCurve_EvaluatePosition(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp5, size5))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::EvaluatePosition(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkLagrangeCurve_EvaluateLocation(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp3, size3))
  {
    ...
    {
      op->vtkLagrangeCurve::EvaluateLocation(temp0, temp1, temp2, temp3);
    }
...
static PyObject *
PyvtkLagrangeCurve_Contour(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp10, "vtkCellData"))
  {
    ...
    {
      op->vtkLagrangeCurve::Contour(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10);
    }
...
static PyObject *
PyvtkLagrangeCurve_Clip(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp9))
  {
    ...
    {
      op->vtkLagrangeCurve::Clip(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9);
    }
...
static PyObject *
PyvtkLagrangeCurve_IntersectWithLine(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp6))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
static PyObject *
PyvtkLagrangeCurve_Triangulate(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkPoints"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::Triangulate(temp0, temp1, temp2));
...
static PyObject *
PyvtkLagrangeCurve_Derivatives(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp4, size4))
  {
    ...
    {
      op->vtkLagrangeCurve::Derivatives(temp0, temp1, temp2, temp3, temp4);
    }
...
static PyObject *
PyvtkLagrangeCurve_GetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    double *tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::GetParametricCoords());
...
static PyObject *
PyvtkLagrangeCurve_GetParametricCenter(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::GetParametricCenter(temp0));
...
static PyObject *
PyvtkLagrangeCurve_GetParametricDistance(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    double tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::GetParametricDistance(temp0));
...
static PyObject *
PyvtkLagrangeCurve_GetOrder_s1(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkLagrangeCurve_GetOrder_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetOrder");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkLagrangeCurve *op = static_cast<vtkLagrangeCurve *>(vp);
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      op->GetOrder(temp0) :
      op->vtkLagrangeCurve::GetOrder(temp0));
...
static PyObject *
PyvtkLagrangeCurve_GetOrder(PyObject *self, PyObject *args)
{
  ...
  {
    case 0:
      return PyvtkLagrangeCurve_GetOrder_s1(self, args);
    case 1:
      return PyvtkLagrangeCurve_GetOrder_s2(self, args);
  }
...
static PyObject *
PyvtkLagrangeCurve_SubCellCoordinatesFromId_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::SubCellCoordinatesFromId(*temp0, temp1));
...
static PyObject *
PyvtkLagrangeCurve_SubCellCoordinatesFromId_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SubCellCoordinatesFromId");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkLagrangeCurve *op = static_cast<vtkLagrangeCurve *>(vp);
...
static PyMethodDef PyvtkLagrangeCurve_SubCellCoordinatesFromId_Methods[] = {
  {nullptr, PyvtkLagrangeCurve_SubCellCoordinatesFromId_s1, METH_VARARGS,
   "@Wi &vtkVector3i"},
  {nullptr, PyvtkLagrangeCurve_SubCellCoordinatesFromId_s2, METH_VARARGS,
   "@ii"},
  {nullptr, nullptr, 0, nullptr}
};

static PyObject *
PyvtkLagrangeCurve_SubCellCoordinatesFromId(PyObject *self, PyObject *args)
{
  PyMethodDef *methods = PyvtkLagrangeCurve_SubCellCoordinatesFromId_Methods;
  int nargs = vtkPythonArgs::GetArgCount(self, args);
...
static PyObject *
PyvtkLagrangeCurve_PointIndexFromIJK(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp2))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::PointIndexFromIJK(temp0, temp1, temp2));
...
static PyObject *
PyvtkLagrangeCurve_TransformApproxToCellParams(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp1, size1))
  {
    ...
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeCurve::TransformApproxToCellParams(temp0, temp1));
...
static PyMethodDef PyvtkLagrangeCurve_Methods[] = {
  ...
  {"GetNumberOfEdges", PyvtkLagrangeCurve_GetNumberOfEdges, METH_VARARGS,
   "V.GetNumberOfEdges() -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkLagrangeCurve_GetNumberOfFaces, METH_VARARGS,
   "V.GetNumberOfFaces() -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkLagrangeCurve_GetEdge, METH_VARARGS,
   "V.GetEdge(int) -> vtkCell\nC++: vtkCell *GetEdge(int) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkLagrangeCurve_GetFace, METH_VARARGS,
   "V.GetFace(int) -> vtkCell\nC++: vtkCell *GetFace(int) override;\n\nReturn the face cell from the faceId of the cell.\n"},
  {"Initialize", PyvtkLagrangeCurve_Initialize, METH_VARARGS,
   "V.Initialize()\nC++: void Initialize() override;\n\n"},
  {"CellBoundary", PyvtkLagrangeCurve_CellBoundary, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkLagrangeCurve_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkLagrangeCurve_EvaluateLocation, METH_VARARGS,
  ...
  {"Contour", PyvtkLagrangeCurve_Contour, METH_VARARGS,
  ...
  {"Clip", PyvtkLagrangeCurve_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkLagrangeCurve_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkLagrangeCurve_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkLagrangeCurve_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkLagrangeCurve_GetParametricCoords, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkLagrangeCurve_GetParametricCenter, METH_VARARGS,
  ...
  {"GetParametricDistance", PyvtkLagrangeCurve_GetParametricDistance, METH_VARARGS,
  ...
  {"GetOrder", PyvtkLagrangeCurve_GetOrder, METH_VARARGS,
  ...
  {"SubCellCoordinatesFromId", PyvtkLagrangeCurve_SubCellCoordinatesFromId, METH_VARARGS,
  ...
  {"PointIndexFromIJK", PyvtkLagrangeCurve_PointIndexFromIJK, METH_VARARGS,
   "V.PointIndexFromIJK(int, int, int) -> int\nC++: int PointIndexFromIJK(int i, int, int)\n\n"},
  {"TransformApproxToCellParams", PyvtkLagrangeCurve_TransformApproxToCellParams, METH_VARARGS,
...
static PyTypeObject PyvtkLagrangeCurve_Type = {
  ...
  "vtkCommonDataModelPython.vtkLagrangeCurve", // tp_name
...
PyObject *PyvtkLagrangeCurve_ClassNew()
{
 ...
 &PyvtkLagrangeCurve_StaticNew);
  ...
  PyTypeObject *pytype = &PyvtkLagrangeCurve_Type;
