...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkLagrangeHexahedron(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkLagrangeHexahedron_ClassNew(); }
...
static PyObject *
PyvtkLagrangeHexahedron_IsTypeOf(PyObject *, PyObject *args)
{
...
static PyObject *
PyvtkLagrangeHexahedron_SafeDownCast(PyObject *, PyObject *args)
{
...
static PyObject *
PyvtkLagrangeHexahedron_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetCellDimension() :
      op->vtkLagrangeHexahedron::GetCellDimension());
...
static PyObject *
PyvtkLagrangeHexahedron_RequiresInitialization(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::RequiresInitialization());
...
static PyObject *
PyvtkLagrangeHexahedron_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfEdges() :
      op->vtkLagrangeHexahedron::GetNumberOfEdges());
...
static PyObject *
PyvtkLagrangeHexahedron_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfFaces() :
      op->vtkLagrangeHexahedron::GetNumberOfFaces());
...
static PyObject *
PyvtkLagrangeHexahedron_Initialize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    {
      op->vtkLagrangeHexahedron::Initialize();
    }
...
static PyObject *
PyvtkLagrangeHexahedron_CellBoundary(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkIdList"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::CellBoundary(temp0, temp1, temp2));
...
static PyObject *
PyvtkLagrangeHexahedron_EvaluatePosition(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp5, size5))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::EvaluatePosition(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkLagrangeHexahedron_EvaluateLocation(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp3, size3))
  {
    ...
    {
      op->vtkLagrangeHexahedron::EvaluateLocation(temp0, temp1, temp2, temp3);
    }
...
static PyObject *
PyvtkLagrangeHexahedron_Contour(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp10, "vtkCellData"))
  {
    ...
    {
      op->vtkLagrangeHexahedron::Contour(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10);
    }
...
static PyObject *
PyvtkLagrangeHexahedron_Clip(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp9))
  {
    ...
    {
      op->vtkLagrangeHexahedron::Clip(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9);
    }
...
static PyObject *
PyvtkLagrangeHexahedron_IntersectWithLine(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp6))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
static PyObject *
PyvtkLagrangeHexahedron_Triangulate(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkPoints"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::Triangulate(temp0, temp1, temp2));
...
static PyObject *
PyvtkLagrangeHexahedron_Derivatives(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp4, size4))
  {
    ...
    {
      op->vtkLagrangeHexahedron::Derivatives(temp0, temp1, temp2, temp3, temp4);
    }
...
static PyObject *
PyvtkLagrangeHexahedron_GetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    double *tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::GetParametricCoords());
...
static PyObject *
PyvtkLagrangeHexahedron_GetParametricCenter(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::GetParametricCenter(temp0));
...
static PyObject *
PyvtkLagrangeHexahedron_GetParametricDistance(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    double tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::GetParametricDistance(temp0));
...
static PyObject *
PyvtkLagrangeHexahedron_GetOrder_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    const int *tempr = (ap.IsBound() ?
      op->GetOrder() :
      op->vtkLagrangeHexahedron::GetOrder());
...
static PyObject *
PyvtkLagrangeHexahedron_GetOrder_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetOrder");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkLagrangeHexahedron *op = static_cast<vtkLagrangeHexahedron *>(vp);
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      op->GetOrder(temp0) :
      op->vtkLagrangeHexahedron::GetOrder(temp0));
...
static PyObject *
PyvtkLagrangeHexahedron_GetOrder(PyObject *self, PyObject *args)
{
  ...
  {
    case 0:
      return PyvtkLagrangeHexahedron_GetOrder_s1(self, args);
    case 1:
      return PyvtkLagrangeHexahedron_GetOrder_s2(self, args);
  }
...
static PyObject *
PyvtkLagrangeHexahedron_SubCellCoordinatesFromId_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::SubCellCoordinatesFromId(*temp0, temp1));
...
static PyObject *
PyvtkLagrangeHexahedron_SubCellCoordinatesFromId_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SubCellCoordinatesFromId");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkLagrangeHexahedron *op = static_cast<vtkLagrangeHexahedron *>(vp);
      ...
      ap.GetValue(temp3))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::SubCellCoordinatesFromId(temp0, temp1, temp2, temp3));
...
static PyObject *
PyvtkLagrangeHexahedron_SubCellCoordinatesFromId(PyObject *self, PyObject *args)
{
  int nargs = vtkPythonArgs::GetArgCount(self, args);
  ...
  {
    case 2:
      return PyvtkLagrangeHexahedron_SubCellCoordinatesFromId_s1(self, args);
    case 4:
      return PyvtkLagrangeHexahedron_SubCellCoordinatesFromId_s2(self, args);
  }
...
static PyObject *
PyvtkLagrangeHexahedron_PointIndexFromIJK_s1(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(4) &&
      ...
      ap.GetArray(temp3, size3))
  {
    int tempr = vtkLagrangeHexahedron::PointIndexFromIJK(temp0, temp1, temp2, temp3);
...
static PyObject *
PyvtkLagrangeHexahedron_PointIndexFromIJK_s2(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp2))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::PointIndexFromIJK(temp0, temp1, temp2));
...
static PyMethodDef PyvtkLagrangeHexahedron_PointIndexFromIJK_Methods[] = {
  {nullptr, PyvtkLagrangeHexahedron_PointIndexFromIJK_s1, METH_VARARGS | METH_STATIC,
   "iiiP *i"},
  {nullptr, nullptr, 0, nullptr}
};

static PyObject *
PyvtkLagrangeHexahedron_PointIndexFromIJK(PyObject *self, PyObject *args)
{
  PyMethodDef *methods = PyvtkLagrangeHexahedron_PointIndexFromIJK_Methods;
  int nargs = vtkPythonArgs::GetArgCount(args);

  switch(nargs)
  {
    case 3:
      return PyvtkLagrangeHexahedron_PointIndexFromIJK_s2(self, args);
    case 4:
...
static PyObject *
PyvtkLagrangeHexahedron_TransformApproxToCellParams(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp1, size1))
  {
    ...
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::TransformApproxToCellParams(temp0, temp1));
...
static PyObject *
PyvtkLagrangeHexahedron_TransformFaceToCellParams(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp1, size1))
  {
    ...
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeHexahedron::TransformFaceToCellParams(temp0, temp1));
...
static PyMethodDef PyvtkLagrangeHexahedron_Methods[] = {
  ...
  {"GetCellDimension", PyvtkLagrangeHexahedron_GetCellDimension, METH_VARARGS,
   "V.GetCellDimension() -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"RequiresInitialization", PyvtkLagrangeHexahedron_RequiresInitialization, METH_VARARGS,
  ...
  {"GetNumberOfEdges", PyvtkLagrangeHexahedron_GetNumberOfEdges, METH_VARARGS,
   "V.GetNumberOfEdges() -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkLagrangeHexahedron_GetNumberOfFaces, METH_VARARGS,
  ...
  {"Initialize", PyvtkLagrangeHexahedron_Initialize, METH_VARARGS,
   "V.Initialize()\nC++: void Initialize() override;\n\n"},
  {"CellBoundary", PyvtkLagrangeHexahedron_CellBoundary, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkLagrangeHexahedron_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkLagrangeHexahedron_EvaluateLocation, METH_VARARGS,
  ...
  {"Contour", PyvtkLagrangeHexahedron_Contour, METH_VARARGS,
  ...
  {"Clip", PyvtkLagrangeHexahedron_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkLagrangeHexahedron_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkLagrangeHexahedron_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkLagrangeHexahedron_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkLagrangeHexahedron_GetParametricCoords, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkLagrangeHexahedron_GetParametricCenter, METH_VARARGS,
  ...
  {"GetParametricDistance", PyvtkLagrangeHexahedron_GetParametricDistance, METH_VARARGS,
  ...
  {"GetOrder", PyvtkLagrangeHexahedron_GetOrder, METH_VARARGS,
  ...
  {"SubCellCoordinatesFromId", PyvtkLagrangeHexahedron_SubCellCoordinatesFromId, METH_VARARGS,
  ...
  {"PointIndexFromIJK", PyvtkLagrangeHexahedron_PointIndexFromIJK, METH_VARARGS,
  ...
  {"TransformApproxToCellParams", PyvtkLagrangeHexahedron_TransformApproxToCellParams, METH_VARARGS,
   "V.TransformApproxToCellParams(int, [float, ...]) -> bool\nC++: bool TransformApproxToCellParams(int subCell,\n    double *pcoords)\n\n"},
  {"TransformFaceToCellParams", PyvtkLagrangeHexahedron_TransformFaceToCellParams, METH_VARARGS,
...
static PyTypeObject PyvtkLagrangeHexahedron_Type = {
  ...
  "vtkCommonDataModelPython.vtkLagrangeHexahedron", // tp_name
...
PyObject *PyvtkLagrangeHexahedron_ClassNew()
{
 ...
 &PyvtkLagrangeHexahedron_StaticNew);
  ...
  PyTypeObject *pytype = &PyvtkLagrangeHexahedron_Type;
