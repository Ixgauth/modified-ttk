...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkLagrangeQuadrilateral(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkLagrangeQuadrilateral_ClassNew(); }
...
static PyObject *
PyvtkLagrangeQuadrilateral_IsTypeOf(PyObject *, PyObject *args)
{
...
static PyObject *
PyvtkLagrangeQuadrilateral_SafeDownCast(PyObject *, PyObject *args)
{
...
static PyObject *
PyvtkLagrangeQuadrilateral_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetCellDimension() :
      op->vtkLagrangeQuadrilateral::GetCellDimension());
...
static PyObject *
PyvtkLagrangeQuadrilateral_RequiresInitialization(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::RequiresInitialization());
...
static PyObject *
PyvtkLagrangeQuadrilateral_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfEdges() :
      op->vtkLagrangeQuadrilateral::GetNumberOfEdges());
...
static PyObject *
PyvtkLagrangeQuadrilateral_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfFaces() :
      op->vtkLagrangeQuadrilateral::GetNumberOfFaces());
...
static PyObject *
PyvtkLagrangeQuadrilateral_GetFace(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    vtkCell *tempr = (ap.IsBound() ?
      op->GetFace(temp0) :
      op->vtkLagrangeQuadrilateral::GetFace(temp0));
...
static PyObject *
PyvtkLagrangeQuadrilateral_Initialize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    {
      op->vtkLagrangeQuadrilateral::Initialize();
    }
...
static PyObject *
PyvtkLagrangeQuadrilateral_CellBoundary(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkIdList"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::CellBoundary(temp0, temp1, temp2));
...
static PyObject *
PyvtkLagrangeQuadrilateral_EvaluatePosition(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp5, size5))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::EvaluatePosition(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkLagrangeQuadrilateral_EvaluateLocation(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp3, size3))
  {
    ...
    {
      op->vtkLagrangeQuadrilateral::EvaluateLocation(temp0, temp1, temp2, temp3);
    }
...
static PyObject *
PyvtkLagrangeQuadrilateral_Contour(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp10, "vtkCellData"))
  {
    ...
    {
      op->vtkLagrangeQuadrilateral::Contour(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10);
    }
...
static PyObject *
PyvtkLagrangeQuadrilateral_Clip(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp9))
  {
    ...
    {
      op->vtkLagrangeQuadrilateral::Clip(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9);
    }
...
static PyObject *
PyvtkLagrangeQuadrilateral_IntersectWithLine(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp6))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
static PyObject *
PyvtkLagrangeQuadrilateral_Triangulate(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkPoints"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::Triangulate(temp0, temp1, temp2));
...
static PyObject *
PyvtkLagrangeQuadrilateral_Derivatives(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp4, size4))
  {
    ...
    {
      op->vtkLagrangeQuadrilateral::Derivatives(temp0, temp1, temp2, temp3, temp4);
    }
...
static PyObject *
PyvtkLagrangeQuadrilateral_GetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    double *tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::GetParametricCoords());
...
static PyObject *
PyvtkLagrangeQuadrilateral_GetParametricCenter(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::GetParametricCenter(temp0));
...
static PyObject *
PyvtkLagrangeQuadrilateral_GetParametricDistance(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    double tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::GetParametricDistance(temp0));
...
static PyObject *
PyvtkLagrangeQuadrilateral_GetOrder_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    const int *tempr = (ap.IsBound() ?
      op->GetOrder() :
      op->vtkLagrangeQuadrilateral::GetOrder());
...
static PyObject *
PyvtkLagrangeQuadrilateral_GetOrder_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetOrder");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkLagrangeQuadrilateral *op = static_cast<vtkLagrangeQuadrilateral *>(vp);
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      op->GetOrder(temp0) :
      op->vtkLagrangeQuadrilateral::GetOrder(temp0));
...
static PyObject *
PyvtkLagrangeQuadrilateral_GetOrder(PyObject *self, PyObject *args)
{
  ...
  {
    case 0:
      return PyvtkLagrangeQuadrilateral_GetOrder_s1(self, args);
    case 1:
      return PyvtkLagrangeQuadrilateral_GetOrder_s2(self, args);
  }
...
static PyObject *
PyvtkLagrangeQuadrilateral_SubCellCoordinatesFromId_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::SubCellCoordinatesFromId(*temp0, temp1));
...
static PyObject *
PyvtkLagrangeQuadrilateral_SubCellCoordinatesFromId_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SubCellCoordinatesFromId");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkLagrangeQuadrilateral *op = static_cast<vtkLagrangeQuadrilateral *>(vp);
      ...
      ap.GetValue(temp3))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::SubCellCoordinatesFromId(temp0, temp1, temp2, temp3));
...
static PyObject *
PyvtkLagrangeQuadrilateral_SubCellCoordinatesFromId(PyObject *self, PyObject *args)
{
  int nargs = vtkPythonArgs::GetArgCount(self, args);
  ...
  {
    case 2:
      return PyvtkLagrangeQuadrilateral_SubCellCoordinatesFromId_s1(self, args);
    case 4:
      return PyvtkLagrangeQuadrilateral_SubCellCoordinatesFromId_s2(self, args);
  }
...
static PyObject *
PyvtkLagrangeQuadrilateral_PointIndexFromIJK_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp2))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::PointIndexFromIJK(temp0, temp1, temp2));
...
static PyObject *
PyvtkLagrangeQuadrilateral_PointIndexFromIJK_s2(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(3) &&
      ...
      ap.GetArray(temp2, size2))
  {
    int tempr = vtkLagrangeQuadrilateral::PointIndexFromIJK(temp0, temp1, temp2);
...
static PyMethodDef PyvtkLagrangeQuadrilateral_PointIndexFromIJK_Methods[] = {
  {nullptr, PyvtkLagrangeQuadrilateral_PointIndexFromIJK_s1, METH_VARARGS,
   "@iii"},
  {nullptr, PyvtkLagrangeQuadrilateral_PointIndexFromIJK_s2, METH_VARARGS | METH_STATIC,
   "iiP *i"},
  {nullptr, nullptr, 0, nullptr}
};

static PyObject *
PyvtkLagrangeQuadrilateral_PointIndexFromIJK(PyObject *self, PyObject *args)
{
  PyMethodDef *methods = PyvtkLagrangeQuadrilateral_PointIndexFromIJK_Methods;
...
static PyObject *
PyvtkLagrangeQuadrilateral_TransformApproxToCellParams(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp1, size1))
  {
    ...
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeQuadrilateral::TransformApproxToCellParams(temp0, temp1));
...
static PyMethodDef PyvtkLagrangeQuadrilateral_Methods[] = {
  ...
  {"GetCellDimension", PyvtkLagrangeQuadrilateral_GetCellDimension, METH_VARARGS,
   "V.GetCellDimension() -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"RequiresInitialization", PyvtkLagrangeQuadrilateral_RequiresInitialization, METH_VARARGS,
  ...
  {"GetNumberOfEdges", PyvtkLagrangeQuadrilateral_GetNumberOfEdges, METH_VARARGS,
   "V.GetNumberOfEdges() -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkLagrangeQuadrilateral_GetNumberOfFaces, METH_VARARGS,
  ...
  {"GetFace", PyvtkLagrangeQuadrilateral_GetFace, METH_VARARGS,
   "V.GetFace(int) -> vtkCell\nC++: vtkCell *GetFace(int faceId) override;\n\nReturn the face cell from the faceId of the cell.\n"},
  {"Initialize", PyvtkLagrangeQuadrilateral_Initialize, METH_VARARGS,
   "V.Initialize()\nC++: void Initialize() override;\n\n"},
  {"CellBoundary", PyvtkLagrangeQuadrilateral_CellBoundary, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkLagrangeQuadrilateral_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkLagrangeQuadrilateral_EvaluateLocation, METH_VARARGS,
  ...
  {"Contour", PyvtkLagrangeQuadrilateral_Contour, METH_VARARGS,
  ...
  {"Clip", PyvtkLagrangeQuadrilateral_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkLagrangeQuadrilateral_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkLagrangeQuadrilateral_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkLagrangeQuadrilateral_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkLagrangeQuadrilateral_GetParametricCoords, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkLagrangeQuadrilateral_GetParametricCenter, METH_VARARGS,
  ...
  {"GetParametricDistance", PyvtkLagrangeQuadrilateral_GetParametricDistance, METH_VARARGS,
  ...
  {"GetOrder", PyvtkLagrangeQuadrilateral_GetOrder, METH_VARARGS,
  ...
  {"SubCellCoordinatesFromId", PyvtkLagrangeQuadrilateral_SubCellCoordinatesFromId, METH_VARARGS,
  ...
  {"PointIndexFromIJK", PyvtkLagrangeQuadrilateral_PointIndexFromIJK, METH_VARARGS,
  ...
  {"TransformApproxToCellParams", PyvtkLagrangeQuadrilateral_TransformApproxToCellParams, METH_VARARGS,
...
static PyTypeObject PyvtkLagrangeQuadrilateral_Type = {
  ...
  "vtkCommonDataModelPython.vtkLagrangeQuadrilateral", // tp_name
...
PyObject *PyvtkLagrangeQuadrilateral_ClassNew()
{
 ...
 &PyvtkLagrangeQuadrilateral_StaticNew);
  ...
  PyTypeObject *pytype = &PyvtkLagrangeQuadrilateral_Type;
