...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkLagrangeTetra(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkLagrangeTetra_ClassNew(); }
...
static PyObject *
PyvtkLagrangeTetra_IsTypeOf(PyObject *, PyObject *args)
{
...
static PyObject *
PyvtkLagrangeTetra_SafeDownCast(PyObject *, PyObject *args)
{
...
static PyObject *
PyvtkLagrangeTetra_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetCellDimension() :
      op->vtkLagrangeTetra::GetCellDimension());
...
static PyObject *
PyvtkLagrangeTetra_RequiresInitialization(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeTetra::RequiresInitialization());
...
static PyObject *
PyvtkLagrangeTetra_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfEdges() :
      op->vtkLagrangeTetra::GetNumberOfEdges());
...
static PyObject *
PyvtkLagrangeTetra_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfFaces() :
      op->vtkLagrangeTetra::GetNumberOfFaces());
...
static PyObject *
PyvtkLagrangeTetra_Initialize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    {
      op->vtkLagrangeTetra::Initialize();
    }
...
static PyObject *
PyvtkLagrangeTetra_MaximumOrder(PyObject *, PyObject *args)
{
  vtkPythonArgs ap(args, "MaximumOrder");

  PyObject *result = nullptr;

  if (ap.CheckArgCount(0))
  {
    int tempr = vtkLagrangeTetra::MaximumOrder();
...
static PyObject *
PyvtkLagrangeTetra_MaximumNumberOfPoints(PyObject *, PyObject *args)
{
  vtkPythonArgs ap(args, "MaximumNumberOfPoints");

  PyObject *result = nullptr;

  if (ap.CheckArgCount(0))
  {
    int tempr = vtkLagrangeTetra::MaximumNumberOfPoints();
...
static PyObject *
PyvtkLagrangeTetra_CellBoundary(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkIdList"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeTetra::CellBoundary(temp0, temp1, temp2));
...
static PyObject *
PyvtkLagrangeTetra_EvaluatePosition(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp5, size5))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeTetra::EvaluatePosition(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkLagrangeTetra_EvaluateLocation(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp3, size3))
  {
    ...
    {
      op->vtkLagrangeTetra::EvaluateLocation(temp0, temp1, temp2, temp3);
    }
...
static PyObject *
PyvtkLagrangeTetra_Contour(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp10, "vtkCellData"))
  {
    ...
    {
      op->vtkLagrangeTetra::Contour(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10);
    }
...
static PyObject *
PyvtkLagrangeTetra_Clip(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp9))
  {
    ...
    {
      op->vtkLagrangeTetra::Clip(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9);
    }
...
static PyObject *
PyvtkLagrangeTetra_IntersectWithLine(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp6))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeTetra::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
static PyObject *
PyvtkLagrangeTetra_Triangulate(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkPoints"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeTetra::Triangulate(temp0, temp1, temp2));
...
static PyObject *
PyvtkLagrangeTetra_Derivatives(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp4, size4))
  {
    ...
    {
      op->vtkLagrangeTetra::Derivatives(temp0, temp1, temp2, temp3, temp4);
    }
...
static PyObject *
PyvtkLagrangeTetra_GetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    double *tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeTetra::GetParametricCoords());
...
static PyObject *
PyvtkLagrangeTetra_GetParametricCenter(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeTetra::GetParametricCenter(temp0));
...
static PyObject *
PyvtkLagrangeTetra_GetParametricDistance(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    double tempr = (ap.IsBound() ?
      ...
      op->vtkLagrangeTetra::GetParametricDistance(temp0));
...
static PyObject *
PyvtkLagrangeTetra_GetOrder(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkLagrangeTetra_ComputeOrder(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkIdType tempr = (ap.IsBound() ?
      op->ComputeOrder() :
      op->vtkLagrangeTetra::ComputeOrder());
...
static PyObject *
PyvtkLagrangeTetra_ToBarycentricIndex(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp1, size1))
  {
    ...
    {
      op->vtkLagrangeTetra::ToBarycentricIndex(temp0, temp1);
    }
...
static PyObject *
PyvtkLagrangeTetra_ToIndex(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    vtkIdType tempr = (ap.IsBound() ?
      op->ToIndex(temp0) :
      op->vtkLagrangeTetra::ToIndex(temp0));
...
static PyObject *
PyvtkLagrangeTetra_BarycentricIndex(PyObject *, PyObject *args)
{
      ...
      ap.GetValue(temp2))
  {
    ...
    vtkLagrangeTetra::BarycentricIndex(temp0, temp1, temp2);
...
static PyObject *
PyvtkLagrangeTetra_Index(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(2) &&
      ...
      ap.GetValue(temp1))
  {
    vtkIdType tempr = vtkLagrangeTetra::Index(temp0, temp1);
...
static PyMethodDef PyvtkLagrangeTetra_Methods[] = {
  ...
  {"GetCellDimension", PyvtkLagrangeTetra_GetCellDimension, METH_VARARGS,
   "V.GetCellDimension() -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"RequiresInitialization", PyvtkLagrangeTetra_RequiresInitialization, METH_VARARGS,
  ...
  {"GetNumberOfEdges", PyvtkLagrangeTetra_GetNumberOfEdges, METH_VARARGS,
   "V.GetNumberOfEdges() -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkLagrangeTetra_GetNumberOfFaces, METH_VARARGS,
  ...
  {"Initialize", PyvtkLagrangeTetra_Initialize, METH_VARARGS,
   "V.Initialize()\nC++: void Initialize() override;\n\n"},
  {"MaximumOrder", PyvtkLagrangeTetra_MaximumOrder, METH_VARARGS,
   "V.MaximumOrder() -> int\nC++: static int MaximumOrder()\n\n"},
  {"MaximumNumberOfPoints", PyvtkLagrangeTetra_MaximumNumberOfPoints, METH_VARARGS,
   "V.MaximumNumberOfPoints() -> int\nC++: static int MaximumNumberOfPoints()\n\n"},
  {"CellBoundary", PyvtkLagrangeTetra_CellBoundary, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkLagrangeTetra_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkLagrangeTetra_EvaluateLocation, METH_VARARGS,
  ...
  {"Contour", PyvtkLagrangeTetra_Contour, METH_VARARGS,
  ...
  {"Clip", PyvtkLagrangeTetra_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkLagrangeTetra_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkLagrangeTetra_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkLagrangeTetra_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkLagrangeTetra_GetParametricCoords, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkLagrangeTetra_GetParametricCenter, METH_VARARGS,
  ...
  {"GetParametricDistance", PyvtkLagrangeTetra_GetParametricDistance, METH_VARARGS,
  ...
  {"GetOrder", PyvtkLagrangeTetra_GetOrder, METH_VARARGS,
   "V.GetOrder() -> int\nC++: vtkIdType GetOrder()\n\n"},
  {"ComputeOrder", PyvtkLagrangeTetra_ComputeOrder, METH_VARARGS,
   "V.ComputeOrder() -> int\nC++: vtkIdType ComputeOrder()\n\n"},
  {"ToBarycentricIndex", PyvtkLagrangeTetra_ToBarycentricIndex, METH_VARARGS,
   "V.ToBarycentricIndex(int, [int, ...])\nC++: void ToBarycentricIndex(vtkIdType index, vtkIdType *bindex)\n\n"},
  {"ToIndex", PyvtkLagrangeTetra_ToIndex, METH_VARARGS,
   "V.ToIndex((int, ...)) -> int\nC++: vtkIdType ToIndex(const vtkIdType *bindex)\n\n"},
  {"BarycentricIndex", PyvtkLagrangeTetra_BarycentricIndex, METH_VARARGS,
   "V.BarycentricIndex(int, [int, ...], int)\nC++: static void BarycentricIndex(vtkIdType index,\n    vtkIdType *bindex, vtkIdType order)\n\n"},
  {"Index", PyvtkLagrangeTetra_Index, METH_VARARGS,
...
static PyTypeObject PyvtkLagrangeTetra_Type = {
  ...
  "vtkCommonDataModelPython.vtkLagrangeTetra", // tp_name
...
PyObject *PyvtkLagrangeTetra_ClassNew()
{
 ...
 &PyvtkLagrangeTetra_StaticNew);
  ...
  PyTypeObject *pytype = &PyvtkLagrangeTetra_Type;
  ...
  PyObject *dict)
{
  ...
  if (o)
  {
    PyDict_SetItemString(dict, "VTK_LAGRANGE_TETRAHEDRON_MAX_ORDER", o);
    Py_DECREF(o);
  }
}
