...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPVCacheKeeperPipeline(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkPVCacheKeeperPipeline_ClassNew(); }
...
static PyObject *
PyvtkPVCacheKeeperPipeline_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPVCacheKeeperPipeline::IsTypeOf(temp0);
...
static PyMethodDef PyvtkPVCacheKeeperPipeline_Methods[] = {
  {"IsTypeOf", PyvtkPVCacheKeeperPipeline_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPVCacheKeeperPipeline_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPVCacheKeeperPipeline_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkPVCacheKeeperPipeline\nC++: static vtkPVCacheKeeperPipeline *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPVCacheKeeperPipeline_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkPVCacheKeeperPipeline\nC++: vtkPVCacheKeeperPipeline *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkPVCacheKeeperPipeline_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVClientServerCoreRenderingPython.vtkPVCacheKeeperPipeline", // tp_name
  ...
  PyvtkPVCacheKeeperPipeline_Doc, // tp_doc
...
PyObject *PyvtkPVCacheKeeperPipeline_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkPVCacheKeeperPipeline_Type, PyvtkPVCacheKeeperPipeline_Methods,
    "vtkPVCacheKeeperPipeline",
 &PyvtkPVCacheKeeperPipeline_StaticNew);

  PyTypeObject *pytype = &PyvtkPVCacheKeeperPipeline_Type;
...
{
  PyObject *o;
  o = PyvtkPVCacheKeeperPipeline_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPVCacheKeeperPipeline", o) != 0)
  {
    Py_DECREF(o);
  }
