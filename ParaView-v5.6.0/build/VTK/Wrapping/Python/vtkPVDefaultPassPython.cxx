...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPVDefaultPass(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkPVDefaultPass_ClassNew(); }
...
static PyObject *
PyvtkPVDefaultPass_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPVDefaultPass::IsTypeOf(temp0);
...
static PyMethodDef PyvtkPVDefaultPass_Methods[] = {
  {"IsTypeOf", PyvtkPVDefaultPass_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPVDefaultPass_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPVDefaultPass_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkPVDefaultPass\nC++: static vtkPVDefaultPass *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPVDefaultPass_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkPVDefaultPass\nC++: vtkPVDefaultPass *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkPVDefaultPass_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVVTKExtensionsRenderingPython.vtkPVDefaultPass", // tp_name
...
PyObject *PyvtkPVDefaultPass_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkPVDefaultPass_Type, PyvtkPVDefaultPass_Methods,
    "vtkPVDefaultPass",
 &PyvtkPVDefaultPass_StaticNew);

  PyTypeObject *pytype = &PyvtkPVDefaultPass_Type;
...
{
  PyObject *o;
  o = PyvtkPVDefaultPass_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPVDefaultPass", o) != 0)
  {
    Py_DECREF(o);
  }
