...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPVInstantiator(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkPVInstantiator_ClassNew(); }
...
static PyObject *
PyvtkPVInstantiator_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPVInstantiator::IsTypeOf(temp0);
...
static PyMethodDef PyvtkPVInstantiator_Methods[] = {
  {"IsTypeOf", PyvtkPVInstantiator_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPVInstantiator_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPVInstantiator_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkPVInstantiator\nC++: static vtkPVInstantiator *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPVInstantiator_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkPVInstantiator\nC++: vtkPVInstantiator *NewInstance()\n\n"},
  {"CreateInstance", PyvtkPVInstantiator_CreateInstance, METH_VARARGS,
...
static PyTypeObject PyvtkPVInstantiator_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVCommonPython.vtkPVInstantiator", // tp_name
  ...
  PyvtkPVInstantiator_Doc, // tp_doc
...
PyObject *PyvtkPVInstantiator_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkPVInstantiator_Type, PyvtkPVInstantiator_Methods,
    "vtkPVInstantiator",
 &PyvtkPVInstantiator_StaticNew);

  PyTypeObject *pytype = &PyvtkPVInstantiator_Type;
...
{
  PyObject *o;
  o = PyvtkPVInstantiator_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPVInstantiator", o) != 0)
  {
    Py_DECREF(o);
  }
