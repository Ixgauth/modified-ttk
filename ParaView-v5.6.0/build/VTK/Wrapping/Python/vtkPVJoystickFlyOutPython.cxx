...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPVJoystickFlyOut(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkPVJoystickFlyOut_ClassNew(); }
...
static PyObject *
PyvtkPVJoystickFlyOut_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPVJoystickFlyOut::IsTypeOf(temp0);
...
static PyMethodDef PyvtkPVJoystickFlyOut_Methods[] = {
  {"IsTypeOf", PyvtkPVJoystickFlyOut_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPVJoystickFlyOut_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPVJoystickFlyOut_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkPVJoystickFlyOut\nC++: static vtkPVJoystickFlyOut *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPVJoystickFlyOut_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkPVJoystickFlyOut\nC++: vtkPVJoystickFlyOut *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkPVJoystickFlyOut_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVVTKExtensionsRenderingPython.vtkPVJoystickFlyOut", // tp_name
  ...
  PyvtkPVJoystickFlyOut_Doc, // tp_doc
...
PyObject *PyvtkPVJoystickFlyOut_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkPVJoystickFlyOut_Type, PyvtkPVJoystickFlyOut_Methods,
    "vtkPVJoystickFlyOut",
 &PyvtkPVJoystickFlyOut_StaticNew);

  PyTypeObject *pytype = &PyvtkPVJoystickFlyOut_Type;
...
{
  PyObject *o;
  o = PyvtkPVJoystickFlyOut_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPVJoystickFlyOut", o) != 0)
  {
    Py_DECREF(o);
  }
