...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPVRampKeyFrame(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkPVRampKeyFrame_ClassNew(); }
...
static const char *PyvtkPVRampKeyFrame_Doc =
  "vtkPVRampKeyFrame - Interplates lineraly between consecutive key\nframes.\n\n"
  "Superclass: vtkPVKeyFrame\n\n"
;


static PyObject *
PyvtkPVRampKeyFrame_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPVRampKeyFrame::IsTypeOf(temp0);
...
static PyMethodDef PyvtkPVRampKeyFrame_Methods[] = {
  {"IsTypeOf", PyvtkPVRampKeyFrame_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPVRampKeyFrame_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPVRampKeyFrame_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkPVRampKeyFrame\nC++: static vtkPVRampKeyFrame *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPVRampKeyFrame_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkPVRampKeyFrame\nC++: vtkPVRampKeyFrame *NewInstance()\n\n"},
  {"UpdateValue", PyvtkPVRampKeyFrame_UpdateValue, METH_VARARGS,
...
static PyTypeObject PyvtkPVRampKeyFrame_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVAnimationPython.vtkPVRampKeyFrame", // tp_name
  ...
  PyvtkPVRampKeyFrame_Doc, // tp_doc
...
PyObject *PyvtkPVRampKeyFrame_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkPVRampKeyFrame_Type, PyvtkPVRampKeyFrame_Methods,
    "vtkPVRampKeyFrame",
 &PyvtkPVRampKeyFrame_StaticNew);

  PyTypeObject *pytype = &PyvtkPVRampKeyFrame_Type;
...
{
  PyObject *o;
  o = PyvtkPVRampKeyFrame_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPVRampKeyFrame", o) != 0)
  {
    Py_DECREF(o);
  }
