...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPVTextSource(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkPVTextSource_ClassNew(); }
...
static PyObject *
PyvtkPVTextSource_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPVTextSource::IsTypeOf(temp0);
...
static PyMethodDef PyvtkPVTextSource_Methods[] = {
  {"IsTypeOf", PyvtkPVTextSource_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPVTextSource_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPVTextSource_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkPVTextSource\nC++: static vtkPVTextSource *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPVTextSource_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkPVTextSource\nC++: vtkPVTextSource *NewInstance()\n\n"},
  {"SetText", PyvtkPVTextSource_SetText, METH_VARARGS,
   "V.SetText(string)\nC++: virtual void SetText(const char *_arg)\n\nGet/Set the text string to generate in the output.\n"},
  {"GetText", PyvtkPVTextSource_GetText, METH_VARARGS,
   "V.GetText() -> string\nC++: virtual char *GetText()\n\nGet/Set the text string to generate in the output.\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkPVTextSource_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVVTKExtensionsDefaultPython.vtkPVTextSource", // tp_name
...
PyObject *PyvtkPVTextSource_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkPVTextSource_Type, PyvtkPVTextSource_Methods,
    "vtkPVTextSource",
 &PyvtkPVTextSource_StaticNew);

  PyTypeObject *pytype = &PyvtkPVTextSource_Type;
...
{
  PyObject *o;
  o = PyvtkPVTextSource_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPVTextSource", o) != 0)
  {
    Py_DECREF(o);
  }
