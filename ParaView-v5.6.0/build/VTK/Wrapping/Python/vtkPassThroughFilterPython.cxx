...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPassThroughFilter(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkPassThroughFilter_ClassNew(); }
...
static PyObject *
PyvtkPassThroughFilter_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPassThroughFilter::IsTypeOf(temp0);
...
static PyMethodDef PyvtkPassThroughFilter_Methods[] = {
  {"IsTypeOf", PyvtkPassThroughFilter_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPassThroughFilter_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPassThroughFilter_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkPassThroughFilter\nC++: static vtkPassThroughFilter *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPassThroughFilter_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkPassThroughFilter\nC++: vtkPassThroughFilter *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkPassThroughFilter_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkFiltersParallelPython.vtkPassThroughFilter", // tp_name
  ...
  PyvtkPassThroughFilter_Doc, // tp_doc
...
PyObject *PyvtkPassThroughFilter_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkPassThroughFilter_Type, PyvtkPassThroughFilter_Methods,
    "vtkPassThroughFilter",
 &PyvtkPassThroughFilter_StaticNew);

  PyTypeObject *pytype = &PyvtkPassThroughFilter_Type;
...
{
  PyObject *o;
  o = PyvtkPassThroughFilter_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPassThroughFilter", o) != 0)
  {
    Py_DECREF(o);
  }
