...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkProcess(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkProcess_ClassNew(); }
...
static PyObject *
PyvtkProcess_IsTypeOf(PyObject *, PyObject *args)
{
...
static PyTypeObject PyvtkProcess_Type = {
  ...
  "vtkParallelCorePython.vtkProcess", // tp_name
...
PyObject *PyvtkProcess_ClassNew()
{
 ...
 nullptr);
  ...
  PyTypeObject *pytype = &PyvtkProcess_Type;
