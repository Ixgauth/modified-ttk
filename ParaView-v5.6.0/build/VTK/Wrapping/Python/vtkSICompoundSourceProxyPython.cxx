...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSICompoundSourceProxy(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkSICompoundSourceProxy_ClassNew(); }
...
static const char *PyvtkSICompoundSourceProxy_Doc =
  "vtkSICompoundSourceProxy - vtkSICompoundSourceProxy is the\nserver-side helper for a vtkSMCompoundSourceProxy.\n\n"
...
static PyObject *
PyvtkSICompoundSourceProxy_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkSICompoundSourceProxy::IsTypeOf(temp0);
...
static PyMethodDef PyvtkSICompoundSourceProxy_Methods[] = {
  {"IsTypeOf", PyvtkSICompoundSourceProxy_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkSICompoundSourceProxy_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkSICompoundSourceProxy_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkSICompoundSourceProxy\nC++: static vtkSICompoundSourceProxy *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkSICompoundSourceProxy_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkSICompoundSourceProxy\nC++: vtkSICompoundSourceProxy *NewInstance()\n\n"},
  {"GetOutputPort", PyvtkSICompoundSourceProxy_GetOutputPort, METH_VARARGS,
   "V.GetOutputPort(int) -> vtkAlgorithmOutput\nC++: vtkAlgorithmOutput *GetOutputPort(int port) override;\n\nReturns the vtkAlgorithmOutput for an output port, if valid.\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkSICompoundSourceProxy_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVServerImplementationCorePython.vtkSICompoundSourceProxy", // tp_name
  ...
  PyvtkSICompoundSourceProxy_Doc, // tp_doc
...
PyObject *PyvtkSICompoundSourceProxy_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkSICompoundSourceProxy_Type, PyvtkSICompoundSourceProxy_Methods,
    "vtkSICompoundSourceProxy",
 &PyvtkSICompoundSourceProxy_StaticNew);

  PyTypeObject *pytype = &PyvtkSICompoundSourceProxy_Type;
...
{
  PyObject *o;
  o = PyvtkSICompoundSourceProxy_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkSICompoundSourceProxy", o) != 0)
  {
    Py_DECREF(o);
  }
