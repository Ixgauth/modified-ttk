...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSIImageTextureProxy(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkSIImageTextureProxy_ClassNew(); }
...
static PyObject *
PyvtkSIImageTextureProxy_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkSIImageTextureProxy::IsTypeOf(temp0);
...
static PyMethodDef PyvtkSIImageTextureProxy_Methods[] = {
  {"IsTypeOf", PyvtkSIImageTextureProxy_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkSIImageTextureProxy_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkSIImageTextureProxy_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkSIImageTextureProxy\nC++: static vtkSIImageTextureProxy *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkSIImageTextureProxy_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkSIImageTextureProxy\nC++: vtkSIImageTextureProxy *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkSIImageTextureProxy_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVServerImplementationRenderingPython.vtkSIImageTextureProxy", // tp_name
  ...
  PyvtkSIImageTextureProxy_Doc, // tp_doc
...
PyObject *PyvtkSIImageTextureProxy_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkSIImageTextureProxy_Type, PyvtkSIImageTextureProxy_Methods,
    "vtkSIImageTextureProxy",
 &PyvtkSIImageTextureProxy_StaticNew);

  PyTypeObject *pytype = &PyvtkSIImageTextureProxy_Type;
...
{
  PyObject *o;
  o = PyvtkSIImageTextureProxy_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkSIImageTextureProxy", o) != 0)
  {
    Py_DECREF(o);
  }
