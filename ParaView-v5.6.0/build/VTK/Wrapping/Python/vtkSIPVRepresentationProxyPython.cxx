...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSIPVRepresentationProxy(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkSIPVRepresentationProxy_ClassNew(); }
...
static const char *PyvtkSIPVRepresentationProxy_Doc =
  "vtkSIPVRepresentationProxy - vtkSIPVRepresentationProxy is the helper\nfor vtkSMPVRepresentationProxy.\n\n"
  "Superclass: vtkSIProxy\n\n"
;


static PyObject *
PyvtkSIPVRepresentationProxy_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkSIPVRepresentationProxy::IsTypeOf(temp0);
...
static PyMethodDef PyvtkSIPVRepresentationProxy_Methods[] = {
  {"IsTypeOf", PyvtkSIPVRepresentationProxy_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkSIPVRepresentationProxy_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkSIPVRepresentationProxy_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkSIPVRepresentationProxy\nC++: static vtkSIPVRepresentationProxy *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkSIPVRepresentationProxy_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkSIPVRepresentationProxy\nC++: vtkSIPVRepresentationProxy *NewInstance()\n\n"},
  {"AboutToDelete", PyvtkSIPVRepresentationProxy_AboutToDelete, METH_VARARGS,
...
static PyTypeObject PyvtkSIPVRepresentationProxy_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVServerImplementationRenderingPython.vtkSIPVRepresentationProxy", // tp_name
  ...
  PyvtkSIPVRepresentationProxy_Doc, // tp_doc
...
PyObject *PyvtkSIPVRepresentationProxy_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkSIPVRepresentationProxy_Type, PyvtkSIPVRepresentationProxy_Methods,
    "vtkSIPVRepresentationProxy",
 &PyvtkSIPVRepresentationProxy_StaticNew);

  PyTypeObject *pytype = &PyvtkSIPVRepresentationProxy_Type;
...
{
  PyObject *o;
  o = PyvtkSIPVRepresentationProxy_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkSIPVRepresentationProxy", o) != 0)
  {
    Py_DECREF(o);
  }
