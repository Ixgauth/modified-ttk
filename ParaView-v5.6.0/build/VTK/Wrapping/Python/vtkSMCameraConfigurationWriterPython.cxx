...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSMCameraConfigurationWriter(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkSMCameraConfigurationWriter_ClassNew(); }

#ifndef DECLARED_PyvtkSMProxyConfigurationWriter_ClassNew
extern "C" { PyObject *PyvtkSMProxyConfigurationWriter_ClassNew(); }
#define DECLARED_PyvtkSMProxyConfigurationWriter_ClassNew
#endif
...
static PyObject *
PyvtkSMCameraConfigurationWriter_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkSMCameraConfigurationWriter::IsTypeOf(temp0);
...
static PyMethodDef PyvtkSMCameraConfigurationWriter_Methods[] = {
  {"IsTypeOf", PyvtkSMCameraConfigurationWriter_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkSMCameraConfigurationWriter_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkSMCameraConfigurationWriter_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkSMCameraConfigurationWriter\nC++: static vtkSMCameraConfigurationWriter *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkSMCameraConfigurationWriter_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkSMCameraConfigurationWriter\nC++: vtkSMCameraConfigurationWriter *NewInstance()\n\n"},
  {"SetRenderViewProxy", PyvtkSMCameraConfigurationWriter_SetRenderViewProxy, METH_VARARGS,
...
static PyTypeObject PyvtkSMCameraConfigurationWriter_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVServerManagerDefaultPython.vtkSMCameraConfigurationWriter", // tp_name
  ...
  PyvtkSMCameraConfigurationWriter_Doc, // tp_doc
...
PyObject *PyvtkSMCameraConfigurationWriter_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkSMCameraConfigurationWriter_Type, PyvtkSMCameraConfigurationWriter_Methods,
    "vtkSMCameraConfigurationWriter",
 &PyvtkSMCameraConfigurationWriter_StaticNew);

  PyTypeObject *pytype = &PyvtkSMCameraConfigurationWriter_Type;
  ...
  pytype->tp_base = (PyTypeObject *)PyvtkSMProxyConfigurationWriter_ClassNew();
...
{
  PyObject *o;
  o = PyvtkSMCameraConfigurationWriter_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkSMCameraConfigurationWriter", o) != 0)
  {
    Py_DECREF(o);
  }
