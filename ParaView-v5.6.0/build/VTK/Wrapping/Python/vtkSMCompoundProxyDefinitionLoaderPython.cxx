...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSMCompoundProxyDefinitionLoader(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkSMCompoundProxyDefinitionLoader_ClassNew(); }
...
static PyObject *
PyvtkSMCompoundProxyDefinitionLoader_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkSMCompoundProxyDefinitionLoader::IsTypeOf(temp0);
...
static PyMethodDef PyvtkSMCompoundProxyDefinitionLoader_Methods[] = {
  {"IsTypeOf", PyvtkSMCompoundProxyDefinitionLoader_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkSMCompoundProxyDefinitionLoader_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkSMCompoundProxyDefinitionLoader_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase)\n    -> vtkSMCompoundProxyDefinitionLoader\nC++: static vtkSMCompoundProxyDefinitionLoader *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkSMCompoundProxyDefinitionLoader_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkSMCompoundProxyDefinitionLoader\nC++: vtkSMCompoundProxyDefinitionLoader *NewInstance()\n\n"},
  {"SetRootElement", PyvtkSMCompoundProxyDefinitionLoader_SetRootElement, METH_VARARGS,
   "V.SetRootElement(vtkPVXMLElement)\nC++: virtual void SetRootElement(vtkPVXMLElement *)\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkSMCompoundProxyDefinitionLoader_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVServerManagerCorePython.vtkSMCompoundProxyDefinitionLoader", // tp_name
  ...
  PyvtkSMCompoundProxyDefinitionLoader_Doc, // tp_doc
...
PyObject *PyvtkSMCompoundProxyDefinitionLoader_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkSMCompoundProxyDefinitionLoader_Type, PyvtkSMCompoundProxyDefinitionLoader_Methods,
    "vtkSMCompoundProxyDefinitionLoader",
 &PyvtkSMCompoundProxyDefinitionLoader_StaticNew);

  PyTypeObject *pytype = &PyvtkSMCompoundProxyDefinitionLoader_Type;
...
{
  PyObject *o;
  o = PyvtkSMCompoundProxyDefinitionLoader_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkSMCompoundProxyDefinitionLoader", o) != 0)
  {
    Py_DECREF(o);
  }
