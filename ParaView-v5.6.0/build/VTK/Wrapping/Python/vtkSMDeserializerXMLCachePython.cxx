...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSMDeserializerXMLCache(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkSMDeserializerXMLCache_ClassNew(); }
...
static PyObject *
PyvtkSMDeserializerXMLCache_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkSMDeserializerXMLCache::IsTypeOf(temp0);
...
static PyMethodDef PyvtkSMDeserializerXMLCache_Methods[] = {
  {"IsTypeOf", PyvtkSMDeserializerXMLCache_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkSMDeserializerXMLCache_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkSMDeserializerXMLCache_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkSMDeserializerXMLCache\nC++: static vtkSMDeserializerXMLCache *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkSMDeserializerXMLCache_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkSMDeserializerXMLCache\nC++: vtkSMDeserializerXMLCache *NewInstance()\n\n"},
  {"CacheXMLProxyState", PyvtkSMDeserializerXMLCache_CacheXMLProxyState, METH_VARARGS,
   "V.CacheXMLProxyState(int, vtkPVXMLElement)\nC++: virtual void CacheXMLProxyState(vtkTypeUInt32 id,\n    vtkPVXMLElement *xml)\n\nAllow to register a given XML state for a given proxy GlobalId\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkSMDeserializerXMLCache_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVServerManagerCorePython.vtkSMDeserializerXMLCache", // tp_name
  ...
  PyvtkSMDeserializerXMLCache_Doc, // tp_doc
...
PyObject *PyvtkSMDeserializerXMLCache_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkSMDeserializerXMLCache_Type, PyvtkSMDeserializerXMLCache_Methods,
    "vtkSMDeserializerXMLCache",
 &PyvtkSMDeserializerXMLCache_StaticNew);

  PyTypeObject *pytype = &PyvtkSMDeserializerXMLCache_Type;
...
{
  PyObject *o;
  o = PyvtkSMDeserializerXMLCache_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkSMDeserializerXMLCache", o) != 0)
  {
    Py_DECREF(o);
  }
