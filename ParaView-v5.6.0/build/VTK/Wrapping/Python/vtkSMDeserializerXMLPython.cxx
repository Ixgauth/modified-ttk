...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSMDeserializerXML(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkSMDeserializerXML_ClassNew(); }
...
static PyObject *
PyvtkSMDeserializerXML_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkSMDeserializerXML::IsTypeOf(temp0);
...
static PyMethodDef PyvtkSMDeserializerXML_Methods[] = {
  {"IsTypeOf", PyvtkSMDeserializerXML_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkSMDeserializerXML_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkSMDeserializerXML_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkSMDeserializerXML\nC++: static vtkSMDeserializerXML *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkSMDeserializerXML_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkSMDeserializerXML\nC++: vtkSMDeserializerXML *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkSMDeserializerXML_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVServerManagerCorePython.vtkSMDeserializerXML", // tp_name
  ...
  PyvtkSMDeserializerXML_Doc, // tp_doc
...
PyObject *PyvtkSMDeserializerXML_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkSMDeserializerXML_Type, PyvtkSMDeserializerXML_Methods,
    "vtkSMDeserializerXML",
 &PyvtkSMDeserializerXML_StaticNew);

  PyTypeObject *pytype = &PyvtkSMDeserializerXML_Type;
...
{
  PyObject *o;
  o = PyvtkSMDeserializerXML_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkSMDeserializerXML", o) != 0)
  {
    Py_DECREF(o);
  }
