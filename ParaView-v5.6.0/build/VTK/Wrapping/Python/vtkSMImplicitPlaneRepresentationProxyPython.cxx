...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSMImplicitPlaneRepresentationProxy(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkSMImplicitPlaneRepresentationProxy_ClassNew(); }
...
static PyObject *
PyvtkSMImplicitPlaneRepresentationProxy_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkSMImplicitPlaneRepresentationProxy::IsTypeOf(temp0);
...
static PyMethodDef PyvtkSMImplicitPlaneRepresentationProxy_Methods[] = {
  {"IsTypeOf", PyvtkSMImplicitPlaneRepresentationProxy_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkSMImplicitPlaneRepresentationProxy_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkSMImplicitPlaneRepresentationProxy_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase)\n    -> vtkSMImplicitPlaneRepresentationProxy\nC++: static vtkSMImplicitPlaneRepresentationProxy *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkSMImplicitPlaneRepresentationProxy_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkSMImplicitPlaneRepresentationProxy\nC++: vtkSMImplicitPlaneRepresentationProxy *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkSMImplicitPlaneRepresentationProxy_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVServerManagerRenderingPython.vtkSMImplicitPlaneRepresentationProxy", // tp_name
  ...
  PyvtkSMImplicitPlaneRepresentationProxy_Doc, // tp_doc
...
PyObject *PyvtkSMImplicitPlaneRepresentationProxy_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkSMImplicitPlaneRepresentationProxy_Type, PyvtkSMImplicitPlaneRepresentationProxy_Methods,
    "vtkSMImplicitPlaneRepresentationProxy",
 &PyvtkSMImplicitPlaneRepresentationProxy_StaticNew);

  PyTypeObject *pytype = &PyvtkSMImplicitPlaneRepresentationProxy_Type;
...
{
  PyObject *o;
  o = PyvtkSMImplicitPlaneRepresentationProxy_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkSMImplicitPlaneRepresentationProxy", o) != 0)
  {
    Py_DECREF(o);
  }
