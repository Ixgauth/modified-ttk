...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSMNullProxy(PyObject *); }
extern "C" { VTK_ABI_EXPORT PyObject *PyvtkSMNullProxy_ClassNew(); }
...
static PyObject *
PyvtkSMNullProxy_IsTypeOf(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkSMNullProxy::IsTypeOf(temp0);
...
static PyMethodDef PyvtkSMNullProxy_Methods[] = {
  {"IsTypeOf", PyvtkSMNullProxy_IsTypeOf, METH_VARARGS,
   "V.IsTypeOf(string) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkSMNullProxy_IsA, METH_VARARGS,
   "V.IsA(string) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkSMNullProxy_SafeDownCast, METH_VARARGS,
   "V.SafeDownCast(vtkObjectBase) -> vtkSMNullProxy\nC++: static vtkSMNullProxy *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkSMNullProxy_NewInstance, METH_VARARGS,
   "V.NewInstance() -> vtkSMNullProxy\nC++: vtkSMNullProxy *NewInstance()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static PyTypeObject PyvtkSMNullProxy_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "vtkPVServerManagerCorePython.vtkSMNullProxy", // tp_name
...
PyObject *PyvtkSMNullProxy_ClassNew()
{
  PyVTKClass_Add(
    &PyvtkSMNullProxy_Type, PyvtkSMNullProxy_Methods,
    "vtkSMNullProxy",
 &PyvtkSMNullProxy_StaticNew);

  PyTypeObject *pytype = &PyvtkSMNullProxy_Type;
...
{
  PyObject *o;
  o = PyvtkSMNullProxy_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkSMNullProxy", o) != 0)
  {
    Py_DECREF(o);
  }
