...
int VTK_EXPORT vtkAbstractImageInterpolatorCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetSlidingWindow",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("SlidingWindowOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->SlidingWindowOn();
      return 1;
  ...
  if (!strcmp("SlidingWindowOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->SlidingWindowOff();
      return 1;
  ...
  if (!strcmp("GetSlidingWindow",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
