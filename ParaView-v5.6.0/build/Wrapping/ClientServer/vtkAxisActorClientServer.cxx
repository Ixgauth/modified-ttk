...
int VTK_EXPORT vtkAxisActorCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetExponentVisibility",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetExponentVisibility",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("ExponentVisibilityOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("ExponentVisibilityOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetLastMajorTickPointCorrection",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetLastMajorTickPointCorrection",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("LastMajorTickPointCorrectionOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("LastMajorTickPointCorrectionOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetTitleAlignLocation",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetTitleAlignLocation",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("SetAxisMainLineProperty",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkProperty  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkProperty"))
      {
  ...
  if (!strcmp("GetAxisMainLineProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  if (!strcmp("SetAxisMajorTicksProperty",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkProperty  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkProperty"))
      {
  ...
  if (!strcmp("GetAxisMajorTicksProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  if (!strcmp("SetAxisMinorTicksProperty",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkProperty  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkProperty"))
      {
  ...
  if (!strcmp("GetAxisMinorTicksProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  if (!strcmp("ComputeMaxLabelLength",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[3];
    double   temp20;
    if(msg.GetArgument(0, 2, temp0, 3))
  ...
  if (!strcmp("ComputeTitleLength",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[3];
    double   temp20;
    if(msg.GetArgument(0, 2, temp0, 3))
  ...
  if (!strcmp("GetTitleActor",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("GetExponentActor",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkAxisFollower  *temp20;
      {
  ...
  if (!strcmp("GetTitleProp3D",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("GetExponentProp3D",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProp3DAxisFollower  *temp20;
      {
  ...
  if (!strcmp("SetExponentOffset",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetExponentOffset",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
