...
int VTK_EXPORT vtkAxisCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetRangeLabelsVisible",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetRangeLabelsVisible",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("SetTitleVisible",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetTitleVisible",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("SetLabelFormat",method) && msg.GetNumberOfArguments(0) == 3)
    ...
    if(msg.GetArgument(0, 2, &temp0))
      {
      op->SetLabelFormat(vtkStdString(temp0));
      return 1;
      }
    }
  ...
  if (!strcmp("SetRangeLabelFormat",method) && msg.GetNumberOfArguments(0) == 3)
    ...
    if(msg.GetArgument(0, 2, &temp0))
      {
      op->SetRangeLabelFormat(vtkStdString(temp0));
      return 1;
      }
    }
  ...
  if (!strcmp("GenerateSimpleLabel",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    vtkStdString   temp20;
    if(msg.GetArgument(0, 2, &temp0))
