// ClientServer wrapper for vtkBillboardTextActor3D object
//
...
vtkObjectBase *vtkBillboardTextActor3DClientServerNewCommand(void* /*ctx*/)
{
  return vtkBillboardTextActor3D::New();
}


int VTK_EXPORT vtkBillboardTextActor3DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkBillboardTextActor3D *op = vtkBillboardTextActor3D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkBillboardTextActor3D.  "
  ...
  if (!strcmp("GetDisplayOffset",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int     *temp20;
      {
      temp20 = (op)->GetDisplayOffset();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << vtkClientServerStream::InsertArray(temp20,2) << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("SetDisplayOffset",method) && msg.GetNumberOfArguments(0) == 4)
    {
    int      temp0;
    int      temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetDisplayOffset",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int    temp0[2];
  ...
  if (!strcmp("GetAnchorDC",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double  *temp20;
      {
      temp20 = (op)->GetAnchorDC();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkBillboardTextActor3D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkBillboardTextActor3D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkBillboardTextActor3D", vtkBillboardTextActor3DClientServerNewCommand);
    csi->AddCommandFunction("vtkBillboardTextActor3D", vtkBillboardTextActor3DCommand);
    }
}
