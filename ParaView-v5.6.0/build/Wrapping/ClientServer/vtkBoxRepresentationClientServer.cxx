...
int VTK_EXPORT vtkBoxRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("GetUnderlyingPlane",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    vtkPlane  *temp20;
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = (op)->GetUnderlyingPlane(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("GetTwoPlaneMode",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->GetTwoPlaneMode();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("SetTwoPlaneMode",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("StepForward",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->StepForward();
      return 1;
  ...
  if (!strcmp("StepBackward",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->StepBackward();
      return 1;
