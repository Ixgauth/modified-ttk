// ClientServer wrapper for vtkCinemaLayerRepresentation object
//
...
vtkObjectBase *vtkCinemaLayerRepresentationClientServerNewCommand(void* /*ctx*/)
{
  return vtkCinemaLayerRepresentation::New();
}


int VTK_EXPORT vtkCinemaLayerRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkCinemaLayerRepresentation *op = vtkCinemaLayerRepresentation::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkCinemaLayerRepresentation.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkCinemaLayerRepresentation  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkCinemaLayerRepresentation, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkCinemaLayerRepresentation_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkCinemaLayerRepresentation", vtkCinemaLayerRepresentationClientServerNewCommand);
    csi->AddCommandFunction("vtkCinemaLayerRepresentation", vtkCinemaLayerRepresentationCommand);
    }
}
