...
extern void vtkAbstractCellLinks_Init(vtkClientServerInterpreter* csi);
...
extern void vtkAMRBox_Init(vtkClientServerInterpreter* csi);
extern void vtkAMRUtilities_Init(vtkClientServerInterpreter* csi);
extern void vtkAngularPeriodicDataArray_Init(vtkClientServerInterpreter* csi);
...
extern void vtkArrayListTemplate_Init(vtkClientServerInterpreter* csi);
...
extern void vtkDataSetAttributesFieldList_Init(vtkClientServerInterpreter* csi);
...
extern void vtkHyperTreeGridCursor_Init(vtkClientServerInterpreter* csi);
extern void vtkImageData_Init(vtkClientServerInterpreter* csi);
extern void vtkImageIterator_Init(vtkClientServerInterpreter* csi);
...
extern void vtkLagrangeCurve_Init(vtkClientServerInterpreter* csi);
extern void vtkLagrangeHexahedron_Init(vtkClientServerInterpreter* csi);
extern void vtkLagrangeInterpolation_Init(vtkClientServerInterpreter* csi);
extern void vtkLagrangeQuadrilateral_Init(vtkClientServerInterpreter* csi);
extern void vtkLagrangeTetra_Init(vtkClientServerInterpreter* csi);
extern void vtkLagrangeTriangle_Init(vtkClientServerInterpreter* csi);
extern void vtkLagrangeWedge_Init(vtkClientServerInterpreter* csi);
extern void vtkLine_Init(vtkClientServerInterpreter* csi);
extern void vtkLocator_Init(vtkClientServerInterpreter* csi);
extern void vtkMappedUnstructuredGrid_Init(vtkClientServerInterpreter* csi);
extern void vtkMappedUnstructuredGridCellIterator_Init(vtkClientServerInterpreter* csi);
extern void vtkMarchingSquaresLineCases_Init(vtkClientServerInterpreter* csi);
extern void vtkMarchingCubesTriangleCases_Init(vtkClientServerInterpreter* csi);
...
extern void vtkPartitionedDataSet_Init(vtkClientServerInterpreter* csi);
extern void vtkPartitionedDataSetCollection_Init(vtkClientServerInterpreter* csi);
...
extern void vtkPeriodicDataArray_Init(vtkClientServerInterpreter* csi);
...
extern void vtkPixelExtent_Init(vtkClientServerInterpreter* csi);
extern void vtkPixelTransfer_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSortFieldData_Init(vtkClientServerInterpreter* csi);
extern void vtkSphere_Init(vtkClientServerInterpreter* csi);
extern void vtkSpheres_Init(vtkClientServerInterpreter* csi);
extern void vtkSpline_Init(vtkClientServerInterpreter* csi);
extern void vtkStaticCellLinks_Init(vtkClientServerInterpreter* csi);
extern void vtkStaticCellLinksTemplate_Init(vtkClientServerInterpreter* csi);
extern void vtkStaticCellLocator_Init(vtkClientServerInterpreter* csi);
extern void vtkStaticPointLocator_Init(vtkClientServerInterpreter* csi);
extern void vtkStaticPointLocator2D_Init(vtkClientServerInterpreter* csi);
...
extern void vtkBoundingBox_Init(vtkClientServerInterpreter* csi);
extern void vtkAtom_Init(vtkClientServerInterpreter* csi);
extern void vtkBond_Init(vtkClientServerInterpreter* csi);
...
extern void vtkCellType_Init(vtkClientServerInterpreter* csi);
extern void vtkColor_Init(vtkClientServerInterpreter* csi);
extern void vtkDataArrayDispatcher_Init(vtkClientServerInterpreter* csi);
extern void vtkDispatcher_Init(vtkClientServerInterpreter* csi);
extern void vtkDispatcher_Private_Init(vtkClientServerInterpreter* csi);
extern void vtkDoubleDispatcher_Init(vtkClientServerInterpreter* csi);
extern void vtkIntersectionCounter_Init(vtkClientServerInterpreter* csi);
extern void vtkRect_Init(vtkClientServerInterpreter* csi);
extern void vtkVector_Init(vtkClientServerInterpreter* csi);
extern void vtkVectorOperators_Init(vtkClientServerInterpreter* csi);
...
extern void vtkAMRDataInternals_Init(vtkClientServerInterpreter* csi);
  ...
  vtkClientServerInterpreter *csi)
{
  ...
  vtkHyperTreeGridCursor_Init(csi);
  ...
  vtkColor_Init(csi);
  vtkDataArrayDispatcher_Init(csi);
  vtkDispatcher_Init(csi);
  vtkDispatcher_Private_Init(csi);
  vtkDoubleDispatcher_Init(csi);
