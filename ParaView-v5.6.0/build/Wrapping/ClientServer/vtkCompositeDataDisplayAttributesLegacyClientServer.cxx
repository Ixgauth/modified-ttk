// ClientServer wrapper for vtkCompositeDataDisplayAttributesLegacy object
//
...
vtkObjectBase *vtkCompositeDataDisplayAttributesLegacyClientServerNewCommand(void* /*ctx*/)
{
  return vtkCompositeDataDisplayAttributesLegacy::New();
}


int VTK_EXPORT vtkCompositeDataDisplayAttributesLegacyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkCompositeDataDisplayAttributesLegacy *op = vtkCompositeDataDisplayAttributesLegacy::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkCompositeDataDisplayAttributesLegacy.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkCompositeDataDisplayAttributesLegacy  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkCompositeDataDisplayAttributesLegacy, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkCompositeDataDisplayAttributesLegacy_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkCompositeDataDisplayAttributesLegacy", vtkCompositeDataDisplayAttributesLegacyClientServerNewCommand);
    csi->AddCommandFunction("vtkCompositeDataDisplayAttributesLegacy", vtkCompositeDataDisplayAttributesLegacyCommand);
    }
}
