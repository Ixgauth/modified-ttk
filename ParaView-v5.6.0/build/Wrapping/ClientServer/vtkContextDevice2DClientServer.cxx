// ClientServer wrapper for vtkContextDevice2D object
//
...
vtkObjectBase *vtkContextDevice2DClientServerNewCommand(void* /*ctx*/)
{
  return vtkContextDevice2D::New();
}


int VTK_EXPORT vtkContextDevice2DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkContextDevice2D *op = vtkContextDevice2D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkContextDevice2D.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkContextDevice2D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkContextDevice2D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkContextDevice2D", vtkContextDevice2DClientServerNewCommand);
    csi->AddCommandFunction("vtkContextDevice2D", vtkContextDevice2DCommand);
    }
}
