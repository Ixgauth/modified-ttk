...
int VTK_EXPORT vtkCoordinateCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetCoordinateSystemToPose",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("GetComputedValue",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkViewport  *temp0;
    double  *temp20;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkViewport"))
  ...
  if (!strcmp("GetComputedUserDefinedValue",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkViewport  *temp0;
    double  *temp20;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkViewport"))
