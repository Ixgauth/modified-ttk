...
int VTK_EXPORT vtkDataArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("InsertTuple6",method) && msg.GetNumberOfArguments(0) == 9)
    {
    vtkIdType   temp0;
    double   temp1;
    double   temp2;
  ...
  if (!strcmp("InsertNextTuple6",method) && msg.GetNumberOfArguments(0) == 8)
    {
    double   temp0;
    double   temp1;
    double   temp2;
  ...
  if (!strcmp("Fill",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetFiniteRange",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    double  *temp20;
    if(msg.GetArgument(0, 2, &temp0))
  ...
  if (!strcmp("GetFiniteRange",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double  *temp20;
      {
  ...
  if (!strcmp("L2_NORM_FINITE_RANGE",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkInformationDoubleVectorKey  *temp20;
      {
  ...
  if (!strcmp("UNITS_LABEL",method) && msg.GetNumberOfArguments(0) == 2)
    {
