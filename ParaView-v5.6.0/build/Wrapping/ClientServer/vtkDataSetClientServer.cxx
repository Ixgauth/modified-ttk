...
int VTK_EXPORT vtkDataSetCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("GenerateGhostArray",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int    temp0[6];
    if(msg.GetArgument(0, 2, temp0, 6))
      {
  ...
  if (!strcmp("HasAnyGhostCells",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("HasAnyGhostPoints",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("HasAnyBlankCells",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("HasAnyBlankPoints",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("GetPointGhostArray",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("UpdatePointGhostArrayCache",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("AllocatePointGhostArray",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkUnsignedCharArray  *temp20;
      {
  ...
  if (!strcmp("GetCellGhostArray",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkUnsignedCharArray  *temp20;
      {
  ...
  if (!strcmp("UpdateCellGhostArrayCache",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("AllocateCellGhostArray",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkUnsignedCharArray  *temp20;
      {
