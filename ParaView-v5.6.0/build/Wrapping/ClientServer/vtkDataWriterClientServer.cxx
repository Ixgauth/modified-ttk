...
int VTK_EXPORT vtkDataWriterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetWriteArrayMetaData",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetWriteArrayMetaData",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("WriteArrayMetaDataOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("WriteArrayMetaDataOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
