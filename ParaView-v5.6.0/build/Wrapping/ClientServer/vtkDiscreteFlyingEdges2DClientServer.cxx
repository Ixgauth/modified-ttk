// ClientServer wrapper for vtkDiscreteFlyingEdges2D object
//
...
vtkObjectBase *vtkDiscreteFlyingEdges2DClientServerNewCommand(void* /*ctx*/)
{
  return vtkDiscreteFlyingEdges2D::New();
}


int VTK_EXPORT vtkDiscreteFlyingEdges2DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDiscreteFlyingEdges2D *op = vtkDiscreteFlyingEdges2D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDiscreteFlyingEdges2D.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkDiscreteFlyingEdges2D  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDiscreteFlyingEdges2D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDiscreteFlyingEdges2D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDiscreteFlyingEdges2D", vtkDiscreteFlyingEdges2DClientServerNewCommand);
    csi->AddCommandFunction("vtkDiscreteFlyingEdges2D", vtkDiscreteFlyingEdges2DCommand);
    }
}
