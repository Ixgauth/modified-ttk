// ClientServer wrapper for vtkDiscreteFlyingEdges3D object
//
...
vtkObjectBase *vtkDiscreteFlyingEdges3DClientServerNewCommand(void* /*ctx*/)
{
  return vtkDiscreteFlyingEdges3D::New();
}


int VTK_EXPORT vtkDiscreteFlyingEdges3DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDiscreteFlyingEdges3D *op = vtkDiscreteFlyingEdges3D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDiscreteFlyingEdges3D.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkDiscreteFlyingEdges3D  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDiscreteFlyingEdges3D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDiscreteFlyingEdges3D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDiscreteFlyingEdges3D", vtkDiscreteFlyingEdges3DClientServerNewCommand);
    csi->AddCommandFunction("vtkDiscreteFlyingEdges3D", vtkDiscreteFlyingEdges3DCommand);
    }
}
