// ClientServer wrapper for vtkDiscreteFlyingEdgesClipper2D object
//
...
vtkObjectBase *vtkDiscreteFlyingEdgesClipper2DClientServerNewCommand(void* /*ctx*/)
{
  return vtkDiscreteFlyingEdgesClipper2D::New();
}


int VTK_EXPORT vtkDiscreteFlyingEdgesClipper2DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDiscreteFlyingEdgesClipper2D *op = vtkDiscreteFlyingEdgesClipper2D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDiscreteFlyingEdgesClipper2D.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkDiscreteFlyingEdgesClipper2D  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDiscreteFlyingEdgesClipper2D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDiscreteFlyingEdgesClipper2D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDiscreteFlyingEdgesClipper2D", vtkDiscreteFlyingEdgesClipper2DClientServerNewCommand);
    csi->AddCommandFunction("vtkDiscreteFlyingEdgesClipper2D", vtkDiscreteFlyingEdgesClipper2DCommand);
    }
}
