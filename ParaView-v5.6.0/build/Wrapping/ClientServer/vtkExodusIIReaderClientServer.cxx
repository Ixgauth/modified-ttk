...
int VTK_EXPORT vtkExodusIIReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetIgnoreFileTime",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetIgnoreFileTime",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("IgnoreFileTimeOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->IgnoreFileTimeOn();
      return 1;
  ...
  if (!strcmp("IgnoreFileTimeOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("GetMaxNameLength",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
