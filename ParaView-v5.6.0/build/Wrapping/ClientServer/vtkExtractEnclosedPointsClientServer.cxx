// ClientServer wrapper for vtkExtractEnclosedPoints object
//
...
vtkObjectBase *vtkExtractEnclosedPointsClientServerNewCommand(void* /*ctx*/)
{
  return vtkExtractEnclosedPoints::New();
}


int VTK_EXPORT vtkExtractEnclosedPointsCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkExtractEnclosedPoints *op = vtkExtractEnclosedPoints::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkExtractEnclosedPoints.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkExtractEnclosedPoints  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkExtractEnclosedPoints, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkExtractEnclosedPoints_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkExtractEnclosedPoints", vtkExtractEnclosedPointsClientServerNewCommand);
    csi->AddCommandFunction("vtkExtractEnclosedPoints", vtkExtractEnclosedPointsCommand);
    }
}
