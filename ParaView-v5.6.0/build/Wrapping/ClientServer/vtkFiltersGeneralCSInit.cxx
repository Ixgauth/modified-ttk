...
extern void vtkCellValidator_Init(vtkClientServerInterpreter* csi);
...
extern void vtkCountFaces_Init(vtkClientServerInterpreter* csi);
extern void vtkCountVertices_Init(vtkClientServerInterpreter* csi);
...
extern void vtkDiscreteFlyingEdges2D_Init(vtkClientServerInterpreter* csi);
extern void vtkDiscreteFlyingEdges3D_Init(vtkClientServerInterpreter* csi);
extern void vtkDiscreteFlyingEdgesClipper2D_Init(vtkClientServerInterpreter* csi);
...
extern void vtkMultiBlockFromTimeSeriesFilter_Init(vtkClientServerInterpreter* csi);
...
extern void vtkPointConnectivityFilter_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSampleImplicitFunctionFilter_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSplitByCellScalarFilter_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSubdivisionFilter_Init(vtkClientServerInterpreter* csi);
extern void vtkSubPixelPositionEdgels_Init(vtkClientServerInterpreter* csi);
extern void vtkSynchronizeTimeFilter_Init(vtkClientServerInterpreter* csi);
...
extern void vtkLoopBooleanPolyDataFilter_Init(vtkClientServerInterpreter* csi);
  ...
  vtkClientServerInterpreter *csi)
{
  ...
  vtkMultiBlockFromTimeSeriesFilter_Init(csi);
