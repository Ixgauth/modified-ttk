// ClientServer wrapper for vtkFlyingEdges2D object
//
...
vtkObjectBase *vtkFlyingEdges2DClientServerNewCommand(void* /*ctx*/)
{
  return vtkFlyingEdges2D::New();
}


int VTK_EXPORT vtkFlyingEdges2DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkFlyingEdges2D *op = vtkFlyingEdges2D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkFlyingEdges2D.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkFlyingEdges2D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkFlyingEdges2D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkFlyingEdges2D", vtkFlyingEdges2DClientServerNewCommand);
    csi->AddCommandFunction("vtkFlyingEdges2D", vtkFlyingEdges2DCommand);
    }
}
