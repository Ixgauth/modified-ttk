// ClientServer wrapper for vtkFlyingEdges3D object
//
...
vtkObjectBase *vtkFlyingEdges3DClientServerNewCommand(void* /*ctx*/)
{
  return vtkFlyingEdges3D::New();
}


int VTK_EXPORT vtkFlyingEdges3DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkFlyingEdges3D *op = vtkFlyingEdges3D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkFlyingEdges3D.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkFlyingEdges3D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkFlyingEdges3D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkFlyingEdges3D", vtkFlyingEdges3DClientServerNewCommand);
    csi->AddCommandFunction("vtkFlyingEdges3D", vtkFlyingEdges3DCommand);
    }
}
