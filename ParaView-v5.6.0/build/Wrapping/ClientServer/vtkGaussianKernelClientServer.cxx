// ClientServer wrapper for vtkGaussianKernel object
//
...
vtkObjectBase *vtkGaussianKernelClientServerNewCommand(void* /*ctx*/)
{
  return vtkGaussianKernel::New();
}


int VTK_EXPORT vtkGaussianKernelCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkGaussianKernel *op = vtkGaussianKernel::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkGaussianKernel.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkGaussianKernel, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkGaussianKernel_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkGaussianKernel", vtkGaussianKernelClientServerNewCommand);
    csi->AddCommandFunction("vtkGaussianKernel", vtkGaussianKernelCommand);
    }
}
