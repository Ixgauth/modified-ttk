...
int VTK_EXPORT vtkHyperTreeGridCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("ORIENTATION",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkInformationIntegerKey  *temp20;
      {
  ...
  if (!strcmp("HasMaterialMask",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->HasMaterialMask();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("SetHasInterface",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetHasInterface",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("HasInterfaceOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->HasInterfaceOn();
      return 1;
  ...
  if (!strcmp("HasInterfaceOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->HasInterfaceOff();
      return 1;
  ...
  if (!strcmp("SetInterfaceNormalsName",method) && msg.GetNumberOfArguments(0) == 3)
    {
    char    *temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetInterfaceNormalsName",method) && msg.GetNumberOfArguments(0) == 2)
    {
    char    *temp20;
      {
  ...
  if (!strcmp("SetInterfaceInterceptsName",method) && msg.GetNumberOfArguments(0) == 3)
    {
    char    *temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetInterfaceInterceptsName",method) && msg.GetNumberOfArguments(0) == 2)
    {
    char    *temp20;
      {
  ...
  if (!strcmp("NewCursor",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkIdType   temp0;
    bool   temp1;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      msg.GetArgument(0, 3, &temp1))
      {
      temp20 = (op)->NewCursor(temp0,temp1);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("NewGridCursor",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkIdType   temp0;
    bool   temp1;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      msg.GetArgument(0, 3, &temp1))
      {
      temp20 = (op)->NewGridCursor(temp0,temp1);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("NewGeometricCursor",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkIdType   temp0;
    bool   temp1;
    vtkHyperTreeGridCursor  *temp20;
    if(msg.GetArgument(0, 2, &temp0) &&
      msg.GetArgument(0, 3, &temp1))
      {
      temp20 = (op)->NewGeometricCursor(temp0,temp1);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("NewVonNeumannSuperCursor",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkIdType   temp0;
    bool   temp1;
    vtkHyperTreeGridCursor  *temp20;
    if(msg.GetArgument(0, 2, &temp0) &&
      msg.GetArgument(0, 3, &temp1))
      {
      temp20 = (op)->NewVonNeumannSuperCursor(temp0,temp1);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("NewMooreSuperCursor",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkIdType   temp0;
    bool   temp1;
    vtkHyperTreeGridCursor  *temp20;
    if(msg.GetArgument(0, 2, &temp0) &&
      msg.GetArgument(0, 3, &temp1))
      {
      temp20 = (op)->NewMooreSuperCursor(temp0,temp1);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("GetCell",method) && msg.GetNumberOfArguments(0) == 5)
    {
    int      temp0;
    int      temp1;
    int      temp2;
  ...
  if (!strcmp("GetTree",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkIdType   temp0;
    vtkHyperTree  *temp20;
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = (op)->GetTree(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("SetTree",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkIdType   temp0;
    vtkHyperTree  *temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
      vtkClientServerStreamGetArgumentObject(msg, 0, 3, &temp1, "vtkHyperTree"))
      {
  ...
  if (!strcmp("RecursivelyInitializePureMaterialMask",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkHyperTreeGridCursor  *temp0;
    bool   temp20;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkHyperTreeGridCursor"))
      {
      temp20 = (op)->RecursivelyInitializePureMaterialMask(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("GetPureMaterialMask",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkBitArray  *temp20;
      {
      temp20 = (op)->GetPureMaterialMask();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("GetChildMask",method) && msg.GetNumberOfArguments(0) == 3)
    {
    unsigned int      temp0;
    unsigned int      temp20;
    if(msg.GetArgument(0, 2, &temp0))
  ...
  if (!strcmp("GetShiftedLevelZeroIndex",method) && msg.GetNumberOfArguments(0) == 6)
    {
    vtkIdType   temp0;
    int      temp1;
    int      temp2;
