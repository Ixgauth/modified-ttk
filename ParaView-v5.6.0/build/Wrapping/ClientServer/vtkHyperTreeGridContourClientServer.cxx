// ClientServer wrapper for vtkHyperTreeGridContour object
//
...
vtkObjectBase *vtkHyperTreeGridContourClientServerNewCommand(void* /*ctx*/)
{
  return vtkHyperTreeGridContour::New();
}


int VTK_EXPORT vtkHyperTreeGridContourCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkHyperTreeGridContour *op = vtkHyperTreeGridContour::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkHyperTreeGridContour.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkHyperTreeGridContour  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkHyperTreeGridContour, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkHyperTreeGridContour_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkHyperTreeGridContour", vtkHyperTreeGridContourClientServerNewCommand);
    csi->AddCommandFunction("vtkHyperTreeGridContour", vtkHyperTreeGridContourCommand);
    }
}
