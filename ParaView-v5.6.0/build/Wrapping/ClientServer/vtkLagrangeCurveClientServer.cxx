// ClientServer wrapper for vtkLagrangeCurve object
//
...
vtkObjectBase *vtkLagrangeCurveClientServerNewCommand(void* /*ctx*/)
{
  return vtkLagrangeCurve::New();
}


int VTK_EXPORT vtkLagrangeCurveCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkLagrangeCurve *op = vtkLagrangeCurve::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkLagrangeCurve.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkLagrangeCurve, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkLagrangeCurve_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkLagrangeCurve", vtkLagrangeCurveClientServerNewCommand);
    csi->AddCommandFunction("vtkLagrangeCurve", vtkLagrangeCurveCommand);
    }
}
