// ClientServer wrapper for vtkLagrangeHexahedron object
//
...
vtkObjectBase *vtkLagrangeHexahedronClientServerNewCommand(void* /*ctx*/)
{
  return vtkLagrangeHexahedron::New();
}


int VTK_EXPORT vtkLagrangeHexahedronCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkLagrangeHexahedron *op = vtkLagrangeHexahedron::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkLagrangeHexahedron.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkLagrangeHexahedron, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkLagrangeHexahedron_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkLagrangeHexahedron", vtkLagrangeHexahedronClientServerNewCommand);
    csi->AddCommandFunction("vtkLagrangeHexahedron", vtkLagrangeHexahedronCommand);
    }
}
