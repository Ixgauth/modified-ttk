// ClientServer wrapper for vtkLagrangeQuadrilateral object
//
...
vtkObjectBase *vtkLagrangeQuadrilateralClientServerNewCommand(void* /*ctx*/)
{
  return vtkLagrangeQuadrilateral::New();
}


int VTK_EXPORT vtkLagrangeQuadrilateralCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkLagrangeQuadrilateral *op = vtkLagrangeQuadrilateral::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkLagrangeQuadrilateral.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkLagrangeQuadrilateral  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkLagrangeQuadrilateral, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkLagrangeQuadrilateral_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkLagrangeQuadrilateral", vtkLagrangeQuadrilateralClientServerNewCommand);
    csi->AddCommandFunction("vtkLagrangeQuadrilateral", vtkLagrangeQuadrilateralCommand);
    }
}
