// ClientServer wrapper for vtkLagrangeTriangle object
//
...
vtkObjectBase *vtkLagrangeTriangleClientServerNewCommand(void* /*ctx*/)
{
  return vtkLagrangeTriangle::New();
}


int VTK_EXPORT vtkLagrangeTriangleCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkLagrangeTriangle *op = vtkLagrangeTriangle::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkLagrangeTriangle.  "
  ...
  if (!strcmp("ComputeParametricCoords",method) && msg.GetNumberOfArguments(0) == 4)
    {
    ...
    if(temp0 &&
      ...
      {
      op->ComputeParametricCoords(temp0,temp1);
      return 1;
      }
    }
  ...
  if (!strcmp("eta",method) && msg.GetNumberOfArguments(0) == 5)
    {
    vtkIdType   temp0;
    vtkIdType   temp1;
    double   temp2;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      ...
      msg.GetArgument(0, 4, &temp2))
      {
      temp20 = (op)->eta(temp0,temp1,temp2);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("d_eta",method) && msg.GetNumberOfArguments(0) == 5)
    {
    vtkIdType   temp0;
    vtkIdType   temp1;
    double   temp2;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      ...
      msg.GetArgument(0, 4, &temp2))
      {
      temp20 = (op)->d_eta(temp0,temp1,temp2);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkLagrangeTriangle, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkLagrangeTriangle_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkLagrangeTriangle", vtkLagrangeTriangleClientServerNewCommand);
    csi->AddCommandFunction("vtkLagrangeTriangle", vtkLagrangeTriangleCommand);
    }
}
