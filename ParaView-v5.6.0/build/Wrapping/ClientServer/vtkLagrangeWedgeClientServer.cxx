// ClientServer wrapper for vtkLagrangeWedge object
//
...
vtkObjectBase *vtkLagrangeWedgeClientServerNewCommand(void* /*ctx*/)
{
  return vtkLagrangeWedge::New();
}


int VTK_EXPORT vtkLagrangeWedgeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkLagrangeWedge *op = vtkLagrangeWedge::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkLagrangeWedge.  "
  ...
  if (!strcmp("GetOrder",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    int      temp20;
    if(msg.GetArgument(0, 2, &temp0))
  ...
  if (!strcmp("PointIndexFromIJK",method) && msg.GetNumberOfArguments(0) == 6)
    {
    int      temp0;
    int      temp1;
    int      temp2;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      ...
      temp3)
      {
      temp20 = (op)->PointIndexFromIJK(temp0,temp1,temp2,temp3);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("PointIndexFromIJK",method) && msg.GetNumberOfArguments(0) == 5)
    {
    int      temp0;
    int      temp1;
    int      temp2;
  ...
  if (!strcmp("TransformApproxToCellParams",method) && msg.GetNumberOfArguments(0) == 4)
    {
    int      temp0;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      temp1)
      {
      temp20 = (op)->TransformApproxToCellParams(temp0,temp1);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("TransformFaceToCellParams",method) && msg.GetNumberOfArguments(0) == 4)
    {
    int      temp0;
    vtkClientServerStreamDataArg<double > temp1(msg, 0, 3);
    bool   temp20;
    if(msg.GetArgument(0, 2, &temp0) &&
      temp1)
      {
      temp20 = (op)->TransformFaceToCellParams(temp0,temp1);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("GetNumberOfApproximatingWedges",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkClientServerStreamDataArg<int    > temp0(msg, 0, 2);
    int      temp20;
    if(temp0)
      {
      temp20 = (op)->GetNumberOfApproximatingWedges(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("GetNumberOfApproximatingWedges",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkLagrangeWedge, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkLagrangeWedge_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkLagrangeWedge", vtkLagrangeWedgeClientServerNewCommand);
    csi->AddCommandFunction("vtkLagrangeWedge", vtkLagrangeWedgeCommand);
    }
}
