// ClientServer wrapper for vtkLoopBooleanPolyDataFilter object
//
...
vtkObjectBase *vtkLoopBooleanPolyDataFilterClientServerNewCommand(void* /*ctx*/)
{
  return vtkLoopBooleanPolyDataFilter::New();
}


int VTK_EXPORT vtkLoopBooleanPolyDataFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkLoopBooleanPolyDataFilter *op = vtkLoopBooleanPolyDataFilter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkLoopBooleanPolyDataFilter.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkLoopBooleanPolyDataFilter  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("GetNoIntersectionOutput",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->GetNoIntersectionOutput();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("SetNoIntersectionOutput",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("NoIntersectionOutputOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("NoIntersectionOutputOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkLoopBooleanPolyDataFilter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkLoopBooleanPolyDataFilter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkLoopBooleanPolyDataFilter", vtkLoopBooleanPolyDataFilterClientServerNewCommand);
    csi->AddCommandFunction("vtkLoopBooleanPolyDataFilter", vtkLoopBooleanPolyDataFilterCommand);
    }
}
