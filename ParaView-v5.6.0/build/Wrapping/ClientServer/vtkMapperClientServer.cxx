...
int VTK_EXPORT vtkMapperCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetRelativeCoincidentTopologyPolygonOffsetParameters",method) && msg.GetNumberOfArguments(0) == 4)
    {
    double   temp0;
    double   temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetResolveCoincidentTopologyLineOffsetParameters",method) && msg.GetNumberOfArguments(0) == 4)
    {
    double   temp0;
    double   temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetRelativeCoincidentTopologyLineOffsetParameters",method) && msg.GetNumberOfArguments(0) == 4)
    {
    double   temp0;
    double   temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetResolveCoincidentTopologyPointOffsetParameter",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("SetRelativeCoincidentTopologyPointOffsetParameter",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("CanUseTextureMapForColoring",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkDataObject  *temp0;
    int      temp20;
  ...
  if (!strcmp("ClearColorArrays",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->ClearColorArrays();
      return 1;
  ...
  if (!strcmp("GetColorMapColors",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkUnsignedCharArray  *temp20;
      {
  ...
  if (!strcmp("GetColorCoordinates",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("GetColorTextureMap",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkImageData  *temp20;
      {
