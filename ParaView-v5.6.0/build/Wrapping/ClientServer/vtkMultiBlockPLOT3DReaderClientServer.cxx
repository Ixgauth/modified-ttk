...
int VTK_EXPORT vtkMultiBlockPLOT3DReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetPreserveIntermediateFunctions",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetPreserveIntermediateFunctions",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->GetPreserveIntermediateFunctions();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("PreserveIntermediateFunctionsOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("PreserveIntermediateFunctionsOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("AddFunctionName",method) && msg.GetNumberOfArguments(0) == 3)
    {
    char    *temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
      op->AddFunctionName(vtkStdString(temp0));
      return 1;
      }
    }
  ...
  {
    const char* commandName = "vtkParallelReader";
