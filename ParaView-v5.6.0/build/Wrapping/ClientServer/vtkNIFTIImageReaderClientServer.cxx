...
int VTK_EXPORT vtkNIFTIImageReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("GetPlanarRGB",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("SetPlanarRGB",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("PlanarRGBOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->PlanarRGBOn();
      return 1;
  ...
  if (!strcmp("PlanarRGBOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->PlanarRGBOff();
      return 1;
