...
int VTK_EXPORT vtkObjectCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("AddObserver",method) && msg.GetNumberOfArguments(0) == 5)
    {
    unsigned long     temp0;
    vtkCommand  *temp1;
    float    temp2;
    unsigned long     temp20;
    if(msg.GetArgument(0, 2, &temp0) &&
      vtkClientServerStreamGetArgumentObject(msg, 0, 3, &temp1, "vtkCommand") &&
      msg.GetArgument(0, 4, &temp2))
      {
      temp20 = (op)->AddObserver(temp0,temp1,temp2);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("GetCommand",method) && msg.GetNumberOfArguments(0) == 3)
    {
    unsigned long     temp0;
    vtkCommand  *temp20;
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = (op)->GetCommand(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("RemoveObservers",method) && msg.GetNumberOfArguments(0) == 4)
    {
    unsigned long     temp0;
    vtkCommand  *temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("HasObserver",method) && msg.GetNumberOfArguments(0) == 4)
    {
    unsigned long     temp0;
    vtkCommand  *temp1;
    int      temp20;
    if(msg.GetArgument(0, 2, &temp0) &&
      vtkClientServerStreamGetArgumentObject(msg, 0, 3, &temp1, "vtkCommand"))
      {
      temp20 = (op)->HasObserver(temp0,temp1);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
