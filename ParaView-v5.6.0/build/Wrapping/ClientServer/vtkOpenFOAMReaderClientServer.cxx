...
int VTK_EXPORT vtkOpenFOAMReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SkipZeroTimeOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->SkipZeroTimeOn();
      return 1;
  ...
  if (!strcmp("SkipZeroTimeOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->SkipZeroTimeOff();
      return 1;
  ...
  if (!strcmp("SetUse64BitLabels",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetUse64BitLabels",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("Use64BitLabelsOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->Use64BitLabelsOn();
      return 1;
  ...
  if (!strcmp("Use64BitLabelsOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("GetCopyDataToCellZones",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("SetCopyDataToCellZones",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("CopyDataToCellZonesOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("CopyDataToCellZonesOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetUse64BitFloats",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetUse64BitFloats",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("Use64BitFloatsOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->Use64BitFloatsOn();
      return 1;
  ...
  if (!strcmp("Use64BitFloatsOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
