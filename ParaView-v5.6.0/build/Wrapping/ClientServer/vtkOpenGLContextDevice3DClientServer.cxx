// ClientServer wrapper for vtkOpenGLContextDevice3D object
//
...
vtkObjectBase *vtkOpenGLContextDevice3DClientServerNewCommand(void* /*ctx*/)
{
  return vtkOpenGLContextDevice3D::New();
}


int VTK_EXPORT vtkOpenGLContextDevice3DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkOpenGLContextDevice3D *op = vtkOpenGLContextDevice3D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkOpenGLContextDevice3D.  "
  ...
  if (!strcmp("SafeDownCast",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkObjectBase  *temp0;
    vtkOpenGLContextDevice3D  *temp20;
  ...
  if (!strcmp("Initialize",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkRenderer  *temp0;
    vtkOpenGLContextDevice2D  *temp1;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkRenderer") &&
      vtkClientServerStreamGetArgumentObject(msg, 0, 3, &temp1, "vtkOpenGLContextDevice2D"))
      {
  ...
  {
    const char* commandName = "vtkContextDevice3D";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkOpenGLContextDevice3D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkOpenGLContextDevice3D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkOpenGLContextDevice3D", vtkOpenGLContextDevice3DClientServerNewCommand);
    csi->AddCommandFunction("vtkOpenGLContextDevice3D", vtkOpenGLContextDevice3DCommand);
    }
}
