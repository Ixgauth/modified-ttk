...
int VTK_EXPORT vtkOpenGLRendererCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("HaveApplePrimitiveIdBug",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->HaveApplePrimitiveIdBug();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("HaveAppleQueryAllocationBug",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("IsDualDepthPeelingSupported",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("GetLightingUniforms",method) && msg.GetNumberOfArguments(0) == 2)
    {
    const char    *temp20;
      {
  ...
  if (!strcmp("UpdateLightingUniforms",method) && msg.GetNumberOfArguments(0) == 3)
    {
  ...
  if (!strcmp("GetLightingComplexity",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetLightingCount",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
