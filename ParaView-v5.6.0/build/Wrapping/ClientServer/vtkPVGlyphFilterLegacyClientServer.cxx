// ClientServer wrapper for vtkPVGlyphFilterLegacy object
//
...
vtkObjectBase *vtkPVGlyphFilterLegacyClientServerNewCommand(void* /*ctx*/)
{
  return vtkPVGlyphFilterLegacy::New();
}


int VTK_EXPORT vtkPVGlyphFilterLegacyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPVGlyphFilterLegacy *op = vtkPVGlyphFilterLegacy::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPVGlyphFilterLegacy.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPVGlyphFilterLegacy, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPVGlyphFilterLegacy_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPVGlyphFilterLegacy", vtkPVGlyphFilterLegacyClientServerNewCommand);
    csi->AddCommandFunction("vtkPVGlyphFilterLegacy", vtkPVGlyphFilterLegacyCommand);
    }
}
