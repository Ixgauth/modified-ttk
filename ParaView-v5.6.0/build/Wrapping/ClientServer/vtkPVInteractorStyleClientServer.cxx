...
int VTK_EXPORT vtkPVInteractorStyleCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("GetCameraManipulators",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkCollection  *temp20;
      {
      temp20 = (op)->GetCameraManipulators();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("DollyToPosition",method) && msg.GetNumberOfArguments(0) == 5)
    {
    double   temp0;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      ...
      {
      op->DollyToPosition(temp0,temp1,temp2);
      return 1;
      }
    }
  if (!strcmp("TranslateCamera",method) && msg.GetNumberOfArguments(0) == 7)
    {
    vtkRenderer  *temp0;
    int      temp1;
    int      temp2;
    ...
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkRenderer") &&
      ...
      {
      op->TranslateCamera(temp0,temp1,temp2,temp3,temp4);
      return 1;
      }
    }
