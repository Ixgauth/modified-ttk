...
int VTK_EXPORT vtkPVMetaClipDataSetCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetExactBoxClip",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetExactBoxClip",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->GetExactBoxClip();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("ExactBoxClipOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->ExactBoxClipOn();
      return 1;
  ...
  if (!strcmp("ExactBoxClipOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->ExactBoxClipOff();
      return 1;
