...
int VTK_EXPORT vtkPVPluginLoaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("LoadPluginsFromPluginConfigFile",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("UnregisterLoadPluginCallback",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
      op->UnregisterLoadPluginCallback(temp0);
      return 1;
      }
    }
  if (!strcmp("PluginLibraryUnloaded",method) && msg.GetNumberOfArguments(0) == 3)
    {
    char    *temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
      op->PluginLibraryUnloaded(temp0);
      return 1;
      }
    }
