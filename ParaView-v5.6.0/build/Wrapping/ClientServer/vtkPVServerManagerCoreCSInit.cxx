...
extern void vtkSMAMRLevelsDomain_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSMDiscreteDoubleDomain_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSMExportProxyDepot_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSMInputFileNameDomain_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSMIndexSelectionDomain_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSMPropertyHelper_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSMProxyInitializationHelper_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSMRangeDomainTemplate_Init(vtkClientServerInterpreter* csi);
extern void vtkSMRangedTransferFunctionDomain_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSMSelfGeneratingSourceProxy_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSMSubsetInclusionLatticeDomain_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSMTimeStepIndexDomain_Init(vtkClientServerInterpreter* csi);
extern void vtkSMTrace_Init(vtkClientServerInterpreter* csi);
extern void vtkSMUncheckedPropertyHelper_Init(vtkClientServerInterpreter* csi);
  ...
  vtkClientServerInterpreter *csi)
{
  ...
  vtkSMExportProxyDepot_Init(csi);
  ...
  vtkSMSubsetInclusionLatticeDomain_Init(csi);
