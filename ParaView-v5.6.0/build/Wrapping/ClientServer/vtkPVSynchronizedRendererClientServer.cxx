...
int VTK_EXPORT vtkPVSynchronizedRendererCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetPartitionOrdering",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkPartitionOrderingInterface  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkPartitionOrderingInterface"))
      {
  ...
  if (!strcmp("GetParallelSynchronizer",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkSynchronizedRenderers  *temp20;
      {
      temp20 = (op)->GetParallelSynchronizer();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("GetCSSynchronizer",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkSynchronizedRenderers  *temp20;
      {
      temp20 = (op)->GetCSSynchronizer();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
