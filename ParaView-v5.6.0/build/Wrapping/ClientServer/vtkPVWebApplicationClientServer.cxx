...
int VTK_EXPORT vtkPVWebApplicationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("StillRenderToBuffer",method) && msg.GetNumberOfArguments(0) == 5)
    {
    vtkSMViewProxy  *temp0;
    unsigned long     temp1;
    int      temp2;
  ...
  if (!strcmp("GetLastStillRenderImageSize",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int     *temp20;
      {
      temp20 = (op)->GetLastStillRenderImageSize();
      resultStream.Reset();
