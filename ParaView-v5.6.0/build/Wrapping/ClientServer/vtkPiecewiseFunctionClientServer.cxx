...
int VTK_EXPORT vtkPiecewiseFunctionCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("GetTable",method) && msg.GetNumberOfArguments(0) == 8)
    {
    double   temp0;
    double   temp1;
    int      temp2;
  ...
  if (!strcmp("UseLogScaleOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->UseLogScaleOn();
      return 1;
  ...
  if (!strcmp("UseLogScaleOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->UseLogScaleOff();
      return 1;
