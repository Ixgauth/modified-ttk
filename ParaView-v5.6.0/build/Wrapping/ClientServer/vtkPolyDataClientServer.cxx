...
int VTK_EXPORT vtkPolyDataCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("NeedToBuildCells",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("RemoveGhostCells",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->RemoveGhostCells();
      return 1;
  ...
  if (!strcmp("GetMeshMTime",method) && msg.GetNumberOfArguments(0) == 2)
    {
    unsigned long     temp20;
      {
