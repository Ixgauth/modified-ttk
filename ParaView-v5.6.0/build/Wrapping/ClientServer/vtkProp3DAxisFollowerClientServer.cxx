...
int VTK_EXPORT vtkProp3DAxisFollowerCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetScreenOffsetVector",method) && msg.GetNumberOfArguments(0) == 4)
    {
    double   temp0;
    double   temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetScreenOffsetVector",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[2];
  ...
  if (!strcmp("GetScreenOffsetVector",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double  *temp20;
      {
      temp20 = (op)->GetScreenOffsetVector();
      resultStream.Reset();
