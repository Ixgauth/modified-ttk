...
int VTK_EXPORT vtkReflectionFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetFlipAllInputArrays",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetFlipAllInputArrays",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->GetFlipAllInputArrays();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("FlipAllInputArraysOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("FlipAllInputArraysOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
