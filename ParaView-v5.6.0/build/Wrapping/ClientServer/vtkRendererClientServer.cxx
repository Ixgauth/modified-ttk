...
int VTK_EXPORT vtkRendererCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("DeviceRenderOpaqueGeometry",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetClippingRangeExpansion",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetClippingRangeExpansionMinValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  if (!strcmp("GetClippingRangeExpansionMaxValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  if (!strcmp("GetClippingRangeExpansion",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  if (!strcmp("GetPreserveColorBuffer",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("SetPreserveColorBuffer",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("PreserveColorBufferOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("PreserveColorBufferOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("GetUseDepthPeelingForVolumes",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("UseDepthPeelingForVolumesOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("UseDepthPeelingForVolumesOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("UseFXAAOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->UseFXAAOn();
      return 1;
  ...
  if (!strcmp("UseFXAAOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->UseFXAAOff();
      return 1;
  ...
  if (!strcmp("GetFXAAOptions",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("SetFXAAOptions",method) && msg.GetNumberOfArguments(0) == 3)
    {
  ...
  if (!strcmp("SetUseShadows",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetUseShadows",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("UseShadowsOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->UseShadowsOn();
      return 1;
  ...
  if (!strcmp("UseShadowsOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->UseShadowsOff();
      return 1;
  ...
  if (!strcmp("GetUseHiddenLineRemoval",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("UseHiddenLineRemovalOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("UseHiddenLineRemovalOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
