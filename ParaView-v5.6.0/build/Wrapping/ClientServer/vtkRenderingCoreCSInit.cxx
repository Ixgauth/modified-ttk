...
extern void vtkBillboardTextActor3D_Init(vtkClientServerInterpreter* csi);
...
extern void vtkCIEDE2000_Init(vtkClientServerInterpreter* csi);
...
extern void vtkCompositeDataDisplayAttributesLegacy_Init(vtkClientServerInterpreter* csi);
...
extern void vtkFrameBufferObjectBase_Init(vtkClientServerInterpreter* csi);
extern void vtkFrustumCoverageCuller_Init(vtkClientServerInterpreter* csi);
extern void vtkFXAAOptions_Init(vtkClientServerInterpreter* csi);
...
extern void vtkPointGaussianMapper_Init(vtkClientServerInterpreter* csi);
...
extern void vtkRenderState_Init(vtkClientServerInterpreter* csi);
extern void vtkRenderTimerLog_Init(vtkClientServerInterpreter* csi);
...
extern void vtkRenderWindowInteractor3D_Init(vtkClientServerInterpreter* csi);
...
extern void vtkSkybox_Init(vtkClientServerInterpreter* csi);
...
extern void vtkInteractorStyle3D_Init(vtkClientServerInterpreter* csi);
...
extern void vtkAbstractInteractionDevice_Init(vtkClientServerInterpreter* csi);
extern void vtkAbstractRenderDevice_Init(vtkClientServerInterpreter* csi);
extern void vtkRenderWidget_Init(vtkClientServerInterpreter* csi);
