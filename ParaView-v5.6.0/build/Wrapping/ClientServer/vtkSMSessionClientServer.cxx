...
int VTK_EXPORT vtkSMSessionCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("NotifyAllClients",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkSMMessage  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkSMMessage"))
      {
  ...
  if (!strcmp("NotifyOtherClients",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkSMMessage  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkSMMessage"))
      {
  ...
  if (!strcmp("ConnectToSelf",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    vtkIdType   temp20;
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = (op)->ConnectToSelf(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("ConnectToRemote",method) && msg.GetNumberOfArguments(0) == 5)
    {
    char    *temp0;
    int      temp1;
    int      temp2;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      ...
      {
      temp20 = (op)->ConnectToRemote(temp0,temp1,temp2);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("ConnectToRemote",method) && msg.GetNumberOfArguments(0) == 7)
    {
    char    *temp0;
    int      temp1;
    char    *temp2;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      ...
      {
      temp20 = (op)->ConnectToRemote(temp0,temp1,temp2,temp3,temp4);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
