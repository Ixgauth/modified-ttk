...
int VTK_EXPORT vtkSMSessionProxyManagerCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("GetRegisteredLinkName",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkSMLink  *temp0;
    const char    *temp20;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkSMLink"))
      {
      temp20 = (op)->GetRegisteredLinkName(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("GetInLoadXMLState",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->GetInLoadXMLState();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("SaveRegisteredLinks",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkPVXMLElement  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkPVXMLElement"))
      {
  ...
  if (!strcmp("ClearPrototypes",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->ClearPrototypes();
      return 1;
  ...
  if (!strcmp("FindProxy",method) && msg.GetNumberOfArguments(0) == 5)
    {
    char    *temp0;
    char    *temp1;
    char    *temp2;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      ...
      msg.GetArgument(0, 4, &temp2))
      {
      temp20 = (op)->FindProxy(temp0,temp1,temp2);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("GetExportDepot",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkSMExportProxyDepot  *temp20;
      {
      temp20 = (op)->GetExportDepot();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
