...
int VTK_EXPORT vtkScalarBarActorCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetAnnotationTextProperty",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkTextProperty  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkTextProperty"))
      {
  ...
  if (!strcmp("GetAnnotationTextProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkTextProperty  *temp20;
      {
  ...
  if (!strcmp("SetDrawBelowRangeSwatch",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetDrawBelowRangeSwatch",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("DrawBelowRangeSwatchOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("DrawBelowRangeSwatchOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetBelowRangeAnnotation",method) && msg.GetNumberOfArguments(0) == 3)
    {
    char    *temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetBelowRangeAnnotation",method) && msg.GetNumberOfArguments(0) == 2)
    {
    char    *temp20;
      {
  ...
  if (!strcmp("SetDrawAboveRangeSwatch",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetDrawAboveRangeSwatch",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("DrawAboveRangeSwatchOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("DrawAboveRangeSwatchOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetAboveRangeAnnotation",method) && msg.GetNumberOfArguments(0) == 3)
    {
    char    *temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetAboveRangeAnnotation",method) && msg.GetNumberOfArguments(0) == 2)
    {
    char    *temp20;
      {
  ...
  if (!strcmp("AnnotationTextScalingOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("AnnotationTextScalingOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetUnconstrainedFontSize",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetUnconstrainedFontSize",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("UnconstrainedFontSizeOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("UnconstrainedFontSizeOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
