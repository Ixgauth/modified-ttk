// ClientServer wrapper for vtkSphereTree object
//
...
vtkObjectBase *vtkSphereTreeClientServerNewCommand(void* /*ctx*/)
{
  return vtkSphereTree::New();
}


int VTK_EXPORT vtkSphereTreeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSphereTree *op = vtkSphereTree::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSphereTree.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSphereTree, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSphereTree_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSphereTree", vtkSphereTreeClientServerNewCommand);
    csi->AddCommandFunction("vtkSphereTree", vtkSphereTreeCommand);
    }
}
