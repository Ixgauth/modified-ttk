// ClientServer wrapper for vtkStaticCleanPolyData object
//
...
vtkObjectBase *vtkStaticCleanPolyDataClientServerNewCommand(void* /*ctx*/)
{
  return vtkStaticCleanPolyData::New();
}


int VTK_EXPORT vtkStaticCleanPolyDataCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkStaticCleanPolyData *op = vtkStaticCleanPolyData::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkStaticCleanPolyData.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkStaticCleanPolyData, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkStaticCleanPolyData_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkStaticCleanPolyData", vtkStaticCleanPolyDataClientServerNewCommand);
    csi->AddCommandFunction("vtkStaticCleanPolyData", vtkStaticCleanPolyDataCommand);
    }
}
