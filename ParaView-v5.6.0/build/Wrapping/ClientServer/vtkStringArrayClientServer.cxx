...
int VTK_EXPORT vtkStringArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetValue",method) && msg.GetNumberOfArguments(0) == 4)
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      msg.GetArgument(0, 3, &temp1))
      {
      op->SetValue(temp0,vtkStdString(temp1));
      return 1;
      }
    }
  if (!strcmp("SetValue",method) && msg.GetNumberOfArguments(0) == 4)
  ...
  if (!strcmp("InsertValue",method) && msg.GetNumberOfArguments(0) == 4)
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      msg.GetArgument(0, 3, &temp1))
      {
      op->InsertValue(temp0,vtkStdString(temp1));
      return 1;
      }
    }
  if (!strcmp("InsertValue",method) && msg.GetNumberOfArguments(0) == 4)
  ...
  if (!strcmp("InsertNextValue",method) && msg.GetNumberOfArguments(0) == 3)
    ...
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = (op)->InsertNextValue(vtkStdString(temp0));
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("LookupValue",method) && msg.GetNumberOfArguments(0) == 3)
    ...
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = (op)->LookupValue(vtkStdString(temp0));
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("LookupValue",method) && msg.GetNumberOfArguments(0) == 4)
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      vtkClientServerStreamGetArgumentObject(msg, 0, 3, &temp1, "vtkIdList"))
      {
      op->LookupValue(vtkStdString(temp0),temp1);
      return 1;
      }
    }
  if (!strcmp("LookupValue",method) && msg.GetNumberOfArguments(0) == 3)
