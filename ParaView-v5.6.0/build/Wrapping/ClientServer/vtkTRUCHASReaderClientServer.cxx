// ClientServer wrapper for vtkTRUCHASReader object
//
...
vtkObjectBase *vtkTRUCHASReaderClientServerNewCommand(void* /*ctx*/)
{
  return vtkTRUCHASReader::New();
}


int VTK_EXPORT vtkTRUCHASReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkTRUCHASReader *op = vtkTRUCHASReader::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkTRUCHASReader.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkTRUCHASReader, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkTRUCHASReader_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkTRUCHASReader", vtkTRUCHASReaderClientServerNewCommand);
    csi->AddCommandFunction("vtkTRUCHASReader", vtkTRUCHASReaderCommand);
    }
}
