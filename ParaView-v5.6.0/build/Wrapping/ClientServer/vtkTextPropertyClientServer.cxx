...
int VTK_EXPORT vtkTextPropertyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetFrameColor",method) && msg.GetNumberOfArguments(0) == 5)
    {
    double   temp0;
    double   temp1;
    double   temp2;
  ...
  if (!strcmp("SetFrameColor",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[3];
    if(msg.GetArgument(0, 2, temp0, 3))
      {
  ...
  if (!strcmp("GetFrameColor",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double  *temp20;
      {
  ...
  if (!strcmp("SetFrame",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetFrame",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->GetFrame();
  ...
  if (!strcmp("FrameOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->FrameOn();
      return 1;
  ...
  if (!strcmp("FrameOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->FrameOff();
      return 1;
  ...
  if (!strcmp("SetFrameWidth",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetFrameWidthMinValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetFrameWidthMaxValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetFrameWidth",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("SetUseTightBoundingBox",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetUseTightBoundingBox",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("UseTightBoundingBoxOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("UseTightBoundingBoxOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
