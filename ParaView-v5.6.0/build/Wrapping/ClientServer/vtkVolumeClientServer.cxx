...
int VTK_EXPORT vtkVolumeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("GetGradientOpacityConstant",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    float    temp20;
    if(msg.GetArgument(0, 2, &temp0))
  ...
  if (!strcmp("GetGradientOpacityConstant",method) && msg.GetNumberOfArguments(0) == 2)
    {
    float    temp20;
      {
  ...
  if (!strcmp("GetArraySize",method) && msg.GetNumberOfArguments(0) == 2)
    {
    float    temp20;
      {
  ...
  if (!strcmp("UpdateTransferFunctions",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkRenderer  *temp0;
  ...
  if (!strcmp("UpdateScalarOpacityforSampleSize",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkRenderer  *temp0;
    float    temp1;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkRenderer") &&
