...
int VTK_EXPORT vtkVolumeMapperCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetBlendModeToAverageIntensity",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetBlendModeToIsoSurface",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetAverageIPScalarRange",method) && msg.GetNumberOfArguments(0) == 4)
    {
    double   temp0;
    double   temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetAverageIPScalarRange",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[2];
  ...
  if (!strcmp("GetAverageIPScalarRange",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double  *temp20;
      {
      temp20 = (op)->GetAverageIPScalarRange();
      resultStream.Reset();
