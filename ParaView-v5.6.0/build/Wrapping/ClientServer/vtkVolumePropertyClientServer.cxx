...
int VTK_EXPORT vtkVolumePropertyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetTransferFunction2D",method) && msg.GetNumberOfArguments(0) == 4)
    {
    int      temp0;
    vtkImageData  *temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetTransferFunction2D",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkImageData  *temp0;
  ...
  if (!strcmp("GetTransferFunction2D",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    vtkImageData  *temp20;
    if(msg.GetArgument(0, 2, &temp0))
  ...
  if (!strcmp("GetTransferFunction2D",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkImageData  *temp20;
      {
  ...
  if (!strcmp("SetTransferFunctionMode",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetTransferFunctionModeMinValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetTransferFunctionModeMaxValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetTransferFunctionMode",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetIsoSurfaceValues",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("UpdateMTimes",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->UpdateMTimes();
      return 1;
