...
int VTK_EXPORT vtkWebApplicationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetNumberOfEncoderThreads",method) && msg.GetNumberOfArguments(0) == 3)
    {
    unsigned int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetNumberOfEncoderThreads",method) && msg.GetNumberOfArguments(0) == 2)
    {
    unsigned int      temp20;
      {
  ...
  if (!strcmp("GetLastStillRenderToMTime",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("GetObjectId",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkObject  *temp0;
    std::string   temp20;
