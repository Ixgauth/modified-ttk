// ClientServer wrapper for vtkX3DExporterXMLWriter object
//
...
vtkObjectBase *vtkX3DExporterXMLWriterClientServerNewCommand(void* /*ctx*/)
{
  return vtkX3DExporterXMLWriter::New();
}


int VTK_EXPORT vtkX3DExporterXMLWriterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkX3DExporterXMLWriter *op = vtkX3DExporterXMLWriter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkX3DExporterXMLWriter.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkX3DExporterXMLWriter  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkX3DExporterXMLWriter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkX3DExporterXMLWriter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkX3DExporterXMLWriter", vtkX3DExporterXMLWriterClientServerNewCommand);
    csi->AddCommandFunction("vtkX3DExporterXMLWriter", vtkX3DExporterXMLWriterCommand);
    }
}
