...
int VTK_EXPORT vtkXMLReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("GetColumnArraySelection",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkDataArraySelection  *temp20;
      {
  ...
  if (!strcmp("SetReaderErrorObserver",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkCommand  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkCommand"))
      {
      op->SetReaderErrorObserver(temp0);
      return 1;
      }
    }
  if (!strcmp("GetReaderErrorObserver",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkCommand  *temp20;
      {
  ...
  if (!strcmp("SetParserErrorObserver",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkCommand  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkCommand"))
      {
  ...
  if (!strcmp("GetParserErrorObserver",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkCommand  *temp20;
      {
