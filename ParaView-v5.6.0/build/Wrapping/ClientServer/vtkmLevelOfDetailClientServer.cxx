// ClientServer wrapper for vtkmLevelOfDetail object
//
...
vtkObjectBase *vtkmLevelOfDetailClientServerNewCommand(void* /*ctx*/)
{
  return vtkmLevelOfDetail::New();
}


int VTK_EXPORT vtkmLevelOfDetailCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkmLevelOfDetail *op = vtkmLevelOfDetail::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkmLevelOfDetail.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkmLevelOfDetail, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkmLevelOfDetail_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkmLevelOfDetail", vtkmLevelOfDetailClientServerNewCommand);
    csi->AddCommandFunction("vtkmLevelOfDetail", vtkmLevelOfDetailCommand);
    }
}
