...
#pragma omp parallel for
      ...
      //from the scalar type data structure we will pull the value of the node that has the is equal to what was input
      //this value seems to be what we use to define the persistence of the given contour tree point
      //i guess this will mean we have to change the way in which this value is defined in order to change how the persistence is defined
      ...
      //this seems to be where we are setting the persistence values initially
      template <typename scalarType>
