...
#pragma omp task untied if (stop - right > MINSIZE)
   ...
   struct SharedData {
      ...
      //add another state to the vector
      ...
      //add another arc onto the opened arcs vector
      ...
      //merge two SharedData objects by merging both their state vectors and their opened arc vectors
      ...
      //reserve space for s states and arcs
