...
int ttk::PersistenceDiagram::execute() const{
  ...
  //this seems to be where we are initially defining what will become the persistence values
  //we are going to need to figure out exactly how the inputscalars_ data type is defined which may be rough
