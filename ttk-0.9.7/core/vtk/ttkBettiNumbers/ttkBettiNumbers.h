/// \ingroup vtk
/// \class ttkBettiNumbers
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the bettiNumbers processing package.
///
/// VTK wrapping code for the @BettiNumbers package.
/// 
...
#ifndef TTK_PLUGIN
class VTKFILTERSCORE_EXPORT ttkBettiNumbers
#else
class ttkBettiNumbers
#endif
  ...
  public:
    ...
    static ttkBettiNumbers* New();
    vtkTypeMacro(ttkBettiNumbers, vtkDataSetAlgorithm)
...
//       SetNumberOfOutputPorts(2);
  ...
  private:
    ...
    ttk::BettiNumbers            bettiNumbers_;
